...
// ResponsesEventToSSE formats a Responses stream event with both the event
// name and JSON data, matching strict OpenAI Responses clients.
...
func generateItemID() string {
	return "item_" + strings.TrimPrefix(generateChatCmplID(), "chatcmpl-")
}
