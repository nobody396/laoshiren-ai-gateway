export default {
  ...
  feedback: {
    ...
    form: {
      ...
      description: 'Include repro steps, expected results, and screenshots when possible.',
      category: 'Category',
      titleLabel: 'Title',
      content: 'Content',
    ...
    edit: {
      title: 'Edit Feedback',
      description: 'Update feedback content, category, and attachments. Closed feedback cannot be edited.',
      button: 'Edit',
      save: 'Save Changes',
