...
func (tx *Tx) init() {
	...
	tx.AccountChangeRecord = NewAccountChangeRecordClient(tx.config)
	tx.AccountGroup = NewAccountGroupClient(tx.config)
	tx.AdminAPI = NewAdminAPIClient(tx.config)
	tx.AdminMenu = NewAdminMenuClient(tx.config)
	tx.AdminRole = NewAdminRoleClient(tx.config)
	tx.AdminRoleAPI = NewAdminRoleAPIClient(tx.config)
	tx.AdminRoleMenu = NewAdminRoleMenuClient(tx.config)
	...
	tx.InvoiceRequestOrder = NewInvoiceRequestOrderClient(tx.config)
	tx.PaymentOrder = NewPaymentOrderClient(tx.config)
	tx.PromoCode = NewPromoCodeClient(tx.config)
	tx.PromoCodeUsage = NewPromoCodeUsageClient(tx.config)
	tx.Proxy = NewProxyClient(tx.config)
	tx.RedeemCode = NewRedeemCodeClient(tx.config)
	tx.RedeemCodeBatch = NewRedeemCodeBatchClient(tx.config)
