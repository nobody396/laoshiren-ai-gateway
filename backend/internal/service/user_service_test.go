...
func (m *mockUserRepo) TouchLastActive(context.Context, int64, time.Time) error {
	return nil
}
...
func (m *mockUserRepo) GetByInviteCode(context.Context, string) (*User, error) { return nil, nil }
func (m *mockUserRepo) SetInviteCode(context.Context, int64, string) error     { return nil }
func (m *mockUserRepo) SetInviterAndAgent(context.Context, int64, int64, *int64) error {
	return nil
}
func (m *mockUserRepo) AdminBindUserToAgent(context.Context, int64, int64, bool) error {
	return nil
}
func (m *mockUserRepo) SetFirstRecharged(context.Context, int64) (int, error) {
	return 0, nil
}
func (m *mockUserRepo) MarkFirstInvitedTopup(context.Context, int64, int64) (int, error) {
	return 0, nil
}
func (m *mockUserRepo) GetInviteCodeByUserID(context.Context, int64) (*string, error) {
	return nil, nil
}
func (m *mockUserRepo) CountInvitedByInviterID(context.Context, int64) (int64, error) {
	return 0, nil
}
