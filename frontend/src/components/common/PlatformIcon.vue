<template>
  ...
  >
    <path
      d="M4.2 3h4.3l4.1 5.1L17.1 3h2.7l-5.9 6.9L21 21h-4.3l-4.8-6.1L6.6 21H3.9l6.7-7.9L4.2 3zm3.1 2.1 10.5 13.8h1L8.4 5.1H7.3z"
    />
  </svg>
  ...
  >
    <path
      d="M12 2l1.89 7.2L21 12l-7.11 2.8L12 22l-1.89-7.2L3 12l7.11-2.8L12 2z"
    />
  </svg>
  <!-- Antigravity logo (cloud) -->
  <svg
    v-else-if="platform === 'antigravity'"
    :class="sizeClass"
    viewBox="0 0 24 24"
    fill="currentColor"
  >
