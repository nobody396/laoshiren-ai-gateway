  ...
  admin: {
    ...
    ops: {
      ...
      webhook: {
        ...
        dingtalkTitle: 'DingTalk Alert Group',
        dingtalkHint: 'Add a custom bot to the DingTalk group, then paste the bot webhook here. Signing is recommended.',
        ...
        dingtalkSignSecret: 'DingTalk signing secret',
        dingtalkSignSecretHint: 'Leave empty if signing is not enabled. If keyword security is enabled, include “老实人AI”.',
        ...
        validation: {
          ...
          dingtalkWebhookRequired: 'DingTalk webhook is required when DingTalk notifications are enabled',
