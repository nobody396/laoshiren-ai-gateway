...
GITHUB_RAW_URL="https://raw.githubusercontent.com/bozhouDev/DragonCode-sub2api/main/deploy"
...
main() {
	...
	echo "  POSTGRES_PASSWORD:     saved"
	echo "  ADMIN_PASSWORD:        saved"
	echo "  JWT_SECRET:            saved"
	echo "  TOTP_ENCRYPTION_KEY:   saved"
    echo ""
    ...
    echo ""
	print_info "Admin credentials are stored in .env. Keep that file private."
    echo ""
}
