export default {
  ...
  agent: {
    ...
    typeFirstRechargeInvitee: '首充邀请金（被邀请用户）',
    typeFirstRechargeFriendInvitee: '首充邀请金（好友邀请被邀请用户）',
    typeFirstRechargeReferral: '首充邀请金（普通邀请）',
    type_consumption: 'API 长效分润',
    type_consumption_commission: 'API 长效分润',
    type_consumption_reversal: '消费冲回',
    type_first_recharge_invitee: '首充邀请金（被邀请）',
    type_first_recharge_invitee_bonus: '首充邀请金（被邀请）',
    type_first_recharge_friend_invitee: '首充邀请金（好友邀请被邀请用户）',
    type_first_recharge_friend_invitee_bonus: '首充邀请金（好友邀请被邀请用户）',
    type_first_recharge_referral: '首充邀请金（普通邀请）',
    type_first_recharge_referral_bonus: '首充邀请金（普通邀请）',
  ...
  user: {
    referral: {
      ...
      notBound: '您尚未绑定邀请码',
      firstRechargeReceived: '首充邀请金已到账',
      firstRechargePending: '完成首次充值即可领取邀请金',
      myInviteCode: '我的邀请码及邀请链接',
      inviteHint: '邀请好友注册，好友首次充值时您和好友可获得对应首充邀请金。',
  ...
  profile: {
    ...
    memberSince: '注册时间',
    myInviteCode: '我的邀请码及邀请链接',
    inviteCodeHint: '分享此邀请码给好友，好友注册时填入，好友首次充值时您和好友可获得对应首充邀请金。',
    inviteCodeHintWithRates: '好友首笔真实付费后，您实时获得首笔金额 5% 的 ⚡平台额度；首笔大于等于 ¥50，好友次日额外获得 ⚡5。',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
    enterUsername: '输入用户名',
  ...
  admin: {
    ...
    agents: {
      ...
      inviteeRate: '被邀请用户首充奖励',
      referralRate: '普通邀请首充奖励',
