export default {
  ...
  topup: {
    ...
    monthlyPlanDirectPrice: 'WeChat/Alipay price',
    ...
    monthlyDirectWechatInstruction: 'Add WeChat {contact} and note: Buy {plan}',
    monthlyDirectContactLabel: 'Support WeChat',
    monthlyDirectNoQr: 'Support QR code is not configured',
