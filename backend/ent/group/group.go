...
const (
	...
	// FieldGptImageCallPrice holds the string denoting the gpt_image_call_price field in the database.
	FieldGptImageCallPrice = "gpt_image_call_price"
	...
	AccountChangeRecordsColumn = "group_id"
...
// ByGptImageCallPrice orders the results by the gpt_image_call_price field.
func ByGptImageCallPrice(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldGptImageCallPrice, opts...).ToFunc()
}
