...
// SetGptImageCallPrice sets the "gpt_image_call_price" field.
func (_u *GroupUpdate) SetGptImageCallPrice(v float64) *GroupUpdate {
	_u.mutation.ResetGptImageCallPrice()
	_u.mutation.SetGptImageCallPrice(v)
	return _u
}

// SetNillableGptImageCallPrice sets the "gpt_image_call_price" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableGptImageCallPrice(v *float64) *GroupUpdate {
	if v != nil {
		_u.SetGptImageCallPrice(*v)
	}
	return _u
}

// AddGptImageCallPrice adds value to the "gpt_image_call_price" field.
func (_u *GroupUpdate) AddGptImageCallPrice(v float64) *GroupUpdate {
	_u.mutation.AddGptImageCallPrice(v)
	return _u
}

// ClearGptImageCallPrice clears the value of the "gpt_image_call_price" field.
func (_u *GroupUpdate) ClearGptImageCallPrice() *GroupUpdate {
	_u.mutation.ClearGptImageCallPrice()
	return _u
}
...
func (_u *GroupUpdate) AddAccountChangeRecordIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) AddAccountChangeRecords(v ...*AccountChangeRecord) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearAccountChangeRecords() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveAccountChangeRecordIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveAccountChangeRecords(v ...*AccountChangeRecord) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.GptImageCallPrice(); ok {
		_spec.SetField(group.FieldGptImageCallPrice, field.TypeFloat64, value)
	}
	if value, ok := _u.mutation.AddedGptImageCallPrice(); ok {
		_spec.AddField(group.FieldGptImageCallPrice, field.TypeFloat64, value)
	}
	if _u.mutation.GptImageCallPriceCleared() {
		_spec.ClearField(group.FieldGptImageCallPrice, field.TypeFloat64)
	}
	...
	if _u.mutation.AccountChangeRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.AccountChangeRecordsTable,
			Columns: []string{group.AccountChangeRecordsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetGptImageCallPrice sets the "gpt_image_call_price" field.
func (_u *GroupUpdateOne) SetGptImageCallPrice(v float64) *GroupUpdateOne {
	_u.mutation.ResetGptImageCallPrice()
	_u.mutation.SetGptImageCallPrice(v)
	return _u
}
...
// SetNillableGptImageCallPrice sets the "gpt_image_call_price" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableGptImageCallPrice(v *float64) *GroupUpdateOne {
	if v != nil {
		_u.SetGptImageCallPrice(*v)
	}
	return _u
...
// AddGptImageCallPrice adds value to the "gpt_image_call_price" field.
func (_u *GroupUpdateOne) AddGptImageCallPrice(v float64) *GroupUpdateOne {
	_u.mutation.AddGptImageCallPrice(v)
	return _u
}

// ClearGptImageCallPrice clears the value of the "gpt_image_call_price" field.
func (_u *GroupUpdateOne) ClearGptImageCallPrice() *GroupUpdateOne {
	_u.mutation.ClearGptImageCallPrice()
	return _u
}
...
// AddAccountChangeRecordIDs adds the "account_change_records" edge to the AccountChangeRecord entity by IDs.
func (_u *GroupUpdateOne) AddAccountChangeRecordIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddAccountChangeRecordIDs(ids...)
	return _u
}

// AddAccountChangeRecords adds the "account_change_records" edges to the AccountChangeRecord entity.
func (_u *GroupUpdateOne) AddAccountChangeRecords(v ...*AccountChangeRecord) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAccountChangeRecords clears all "account_change_records" edges to the AccountChangeRecord entity.
func (_u *GroupUpdateOne) ClearAccountChangeRecords() *GroupUpdateOne {
	_u.mutation.ClearAccountChangeRecords()
	return _u
}

// RemoveAccountChangeRecordIDs removes the "account_change_records" edge to AccountChangeRecord entities by IDs.
func (_u *GroupUpdateOne) RemoveAccountChangeRecordIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveAccountChangeRecordIDs(ids...)
	return _u
}

// RemoveAccountChangeRecords removes "account_change_records" edges to AccountChangeRecord entities.
func (_u *GroupUpdateOne) RemoveAccountChangeRecords(v ...*AccountChangeRecord) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
