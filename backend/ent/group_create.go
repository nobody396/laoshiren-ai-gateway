...
func (_c *GroupCreate) SetGptImageCallPrice(v float64) *GroupCreate {
	_c.mutation.SetGptImageCallPrice(v)
	return _c
}

// SetNillableGptImageCallPrice sets the "gpt_image_call_price" field if the given value is not nil.
func (_c *GroupCreate) SetNillableGptImageCallPrice(v *float64) *GroupCreate {
	if v != nil {
		_c.SetGptImageCallPrice(*v)
	}
	return _c
}
...
func (_c *GroupCreate) AddAccountChangeRecordIDs(ids ...int64) *GroupCreate {
...
func (_c *GroupCreate) AddAccountChangeRecords(v ...*AccountChangeRecord) *GroupCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.GptImageCallPrice(); ok {
		_spec.SetField(group.FieldGptImageCallPrice, field.TypeFloat64, value)
		_node.GptImageCallPrice = &value
	}
...
// SetGptImageCallPrice sets the "gpt_image_call_price" field.
func (u *GroupUpsert) SetGptImageCallPrice(v float64) *GroupUpsert {
	u.Set(group.FieldGptImageCallPrice, v)
	return u
}

// UpdateGptImageCallPrice sets the "gpt_image_call_price" field to the value that was provided on create.
func (u *GroupUpsert) UpdateGptImageCallPrice() *GroupUpsert {
	u.SetExcluded(group.FieldGptImageCallPrice)
	return u
}

// AddGptImageCallPrice adds v to the "gpt_image_call_price" field.
func (u *GroupUpsert) AddGptImageCallPrice(v float64) *GroupUpsert {
	u.Add(group.FieldGptImageCallPrice, v)
	return u
}

// ClearGptImageCallPrice clears the value of the "gpt_image_call_price" field.
func (u *GroupUpsert) ClearGptImageCallPrice() *GroupUpsert {
	u.SetNull(group.FieldGptImageCallPrice)
	return u
}
...
// SetGptImageCallPrice sets the "gpt_image_call_price" field.
func (u *GroupUpsertOne) SetGptImageCallPrice(v float64) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetGptImageCallPrice(v)
	})
}

// AddGptImageCallPrice adds v to the "gpt_image_call_price" field.
func (u *GroupUpsertOne) AddGptImageCallPrice(v float64) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.AddGptImageCallPrice(v)
	})
}

// UpdateGptImageCallPrice sets the "gpt_image_call_price" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateGptImageCallPrice() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateGptImageCallPrice()
	})
}

// ClearGptImageCallPrice clears the value of the "gpt_image_call_price" field.
func (u *GroupUpsertOne) ClearGptImageCallPrice() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.ClearGptImageCallPrice()
	})
}
...
// SetGptImageCallPrice sets the "gpt_image_call_price" field.
func (u *GroupUpsertBulk) SetGptImageCallPrice(v float64) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetGptImageCallPrice(v)
	})
}
...
// AddGptImageCallPrice adds v to the "gpt_image_call_price" field.
func (u *GroupUpsertBulk) AddGptImageCallPrice(v float64) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.AddGptImageCallPrice(v)
	})
}
...
// UpdateGptImageCallPrice sets the "gpt_image_call_price" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateGptImageCallPrice() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateGptImageCallPrice()
	})
}
...
// ClearGptImageCallPrice clears the value of the "gpt_image_call_price" field.
func (u *GroupUpsertBulk) ClearGptImageCallPrice() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.ClearGptImageCallPrice()
	})
}
