...
import (
	...
	"github.com/bozhouDev/DragonCode-sub2api/internal/server/routes"
	"github.com/bozhouDev/DragonCode-sub2api/internal/service"
	"github.com/bozhouDev/DragonCode-sub2api/internal/web"
...
func registerRoutes(
	...
	// 支付宝异步通知回调（无 JWT 认证，使用支付宝签名验证）
	v1.POST("/payment/notify", h.Payment.HandleNotify)
