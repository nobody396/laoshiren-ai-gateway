...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/bozhouDev/DragonCode-sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="bozhouDev/DragonCode-sub2api"
...
Documentation=https://github.com/bozhouDev/DragonCode-sub2api
