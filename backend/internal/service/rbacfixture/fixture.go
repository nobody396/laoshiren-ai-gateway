...
func BaselineAPIs() []*service.AdminAPI {
	...
	add("GET", "/admin/redeem-codes/:id", 32, 4)
	add("POST", "/admin/redeem-codes/create-and-redeem", 32, 5)
	add("POST", "/admin/redeem-codes/generate", 32, 6)
	add("DELETE", "/admin/redeem-codes/:id", 32, 7)
	add("POST", "/admin/redeem-codes/batch-delete", 32, 8)
	add("POST", "/admin/redeem-codes/:id/expire", 32, 9)
	...
	add("GET", "/admin/ops/runtime/alert", 53, 15)
	add("PUT", "/admin/ops/runtime/alert", 53, 16)
	add("GET", "/admin/ops/runtime/logging", 53, 17)
	add("PUT", "/admin/ops/runtime/logging", 53, 18)
	add("POST", "/admin/ops/runtime/logging/reset", 53, 19)
	add("GET", "/admin/ops/advanced-settings", 53, 20)
	add("PUT", "/admin/ops/advanced-settings", 53, 21)
	add("GET", "/admin/ops/settings/metric-thresholds", 53, 22)
	add("PUT", "/admin/ops/settings/metric-thresholds", 53, 23)
	add("GET", "/admin/ops/ws/qps", 53, 24)
	add("GET", "/admin/ops/errors", 53, 25)
	add("GET", "/admin/ops/errors/:id", 53, 26)
	add("GET", "/admin/ops/errors/:id/retries", 53, 27)
	add("POST", "/admin/ops/errors/:id/retry", 53, 28)
	add("PUT", "/admin/ops/errors/:id/resolve", 53, 29)
	add("GET", "/admin/ops/request-errors", 53, 30)
	add("GET", "/admin/ops/request-errors/:id", 53, 31)
	add("GET", "/admin/ops/request-errors/:id/upstream-errors", 53, 32)
	add("POST", "/admin/ops/request-errors/:id/retry-client", 53, 33)
	add("POST", "/admin/ops/request-errors/:id/upstream-errors/:idx/retry", 53, 34)
	add("PUT", "/admin/ops/request-errors/:id/resolve", 53, 35)
	add("GET", "/admin/ops/upstream-errors", 53, 36)
	add("GET", "/admin/ops/upstream-errors/:id", 53, 37)
	add("POST", "/admin/ops/upstream-errors/:id/retry", 53, 38)
	add("PUT", "/admin/ops/upstream-errors/:id/resolve", 53, 39)
	add("GET", "/admin/ops/requests", 53, 40)
	add("GET", "/admin/ops/system-logs", 53, 41)
	add("POST", "/admin/ops/system-logs/cleanup", 53, 42)
	add("GET", "/admin/ops/system-logs/health", 53, 43)
	add("GET", "/admin/ops/dashboard/snapshot-v2", 53, 44)
	add("GET", "/admin/ops/dashboard/overview", 53, 45)
	add("GET", "/admin/ops/dashboard/throughput-trend", 53, 46)
	add("GET", "/admin/ops/dashboard/latency-histogram", 53, 47)
	add("GET", "/admin/ops/dashboard/error-trend", 53, 48)
	add("GET", "/admin/ops/dashboard/error-distribution", 53, 49)
	add("GET", "/admin/ops/dashboard/openai-token-stats", 53, 50)
