<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="admin-stat-card card p-4">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              @click="emit('recharge')"
              class="text-xs font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 underline underline-offset-2 transition-colors"
            >{{ t('topup.buttonLabel') }}</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="admin-stat-card card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-purple-100 p-2 dark:bg-purple-900/30">
          <Icon name="bolt" size="md" class="text-purple-600 dark:text-purple-400" :stroke-width="2" />
        </div>
        <div>
