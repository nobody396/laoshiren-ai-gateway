export default {
  ...
  topup: {
    ...
    cardShopChannelTitle: '卡密商城',
    cardShopChannelDesc: '跳转链动小铺购买，付款后回站兑换',
    availableNow: '当前可用',
    comingSoon: '暂未开放',
    ...
    monthlyPlanDirectPrice: '微信/支付宝优惠价',
    ...
    monthlyDirectWechatInstruction: '添加微信 {contact}，备注：购买 {plan}',
    monthlyDirectContactLabel: '客服微信',
    monthlyDirectNoQr: '暂未配置客服二维码',
    productType: '商品类型',
    balanceCard: '余额卡',
    developerMonthlyCard: '开发者月卡',
    cardShopAction: '去卡密商城购买',
