...
func TestAffiliateCommercialPolicy_CatalogAndMarginGate(t *testing.T) {
	...
	require.Equal(t, float64(255), byID["plus"].DirectPriceCNY)
	...
	require.Equal(t, float64(715), byID["pro"].DirectPriceCNY)
	...
	require.Equal(t, float64(1525), byID["max"].DirectPriceCNY)
