export default {
  ...
  agent: {
    ...
    performanceGap: 'Gap',
    levelLight: 'Light Agent',
    levelStandard: 'Standard Agent',
    levelCore: 'Core Agent',
    levelSuper: 'Super Agent',
  ...
  user: {
    referral: {
      ...
      boundAgent: 'You registered via an agent invite code',
  ...
  keys: {
    ...
    ccsClientSelect: {
      ...
      claudeDesktopDesc: 'Compatible import: save to Claude Code first; handle Desktop inside CC Switch',
      claudeDesktopBridgeNotice: 'CC Switch does not currently expose a public Desktop sync deeplink, so this was imported to Claude Code first. If the Desktop page shows "Import existing providers from Claude Code", click it in CC Switch; otherwise add the Desktop provider manually.',
      codex: 'Codex',
  ...
  profile: {
    ...
    inviteCodeHintWithRates: 'Share this code with friends. When they make their first top-up, you receive {referralRate} of the top-up amount and their account balance increases by {inviteeRate}.',
  ...
  admin: {
    ...
    agents: {
      ...
      description: 'Manage agent commissions, invited users, rate settings, and settlements',
      ...
      settlementMinimumHint: 'Manual settlement is allowed only after system amount reaches $50. You can adjust the threshold here.',
      eligibleSettlementCount: 'Ready Agents',
      ...
      runThisAgentLevelEvaluation: 'Run This Agent',
      level_light: 'Light Agent',
      level_standard: 'Standard Agent',
      level_core: 'Core Agent',
      level_super: 'Super Agent',
      ...
      overwriteAgentBinding: 'Overwrite current ownership if the user belongs to another agent',
      ...
      agentLevelEvaluationCompleted: 'Agent evaluation completed',
