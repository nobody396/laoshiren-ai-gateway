...
func BaselineAPIs() []*service.AdminAPI {
	...
	add("GET", "/admin/suppliers/probe-snapshot", 24, 2)
	add("PUT", "/admin/suppliers/probe-enabled", 24, 3)
	...
	add("GET", "/admin/ops/customer-tiers", 53, 66)
	add("GET", "/admin/ops/customer-tiers/users/:id", 53, 67)
