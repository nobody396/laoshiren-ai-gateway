...
func (s *userRepoStubForGroupUpdate) TouchLastActive(context.Context, int64, time.Time) error {
	panic("unexpected")
}
...
func (s *userRepoStubForGroupUpdate) SetInviterAndAgent(context.Context, int64, int64, *int64) error {
	panic("unexpected")
}
func (s *userRepoStubForGroupUpdate) AdminBindUserToAgent(context.Context, int64, int64, bool) error {
	panic("unexpected")
}
func (s *userRepoStubForGroupUpdate) SetFirstRecharged(context.Context, int64) (int, error) {
	panic("unexpected")
}
func (s *userRepoStubForGroupUpdate) MarkFirstInvitedTopup(context.Context, int64, int64) (int, error) {
	panic("unexpected")
}
func (s *userRepoStubForGroupUpdate) GetInviteCodeByUserID(context.Context, int64) (*string, error) {
	panic("unexpected")
}
func (s *userRepoStubForGroupUpdate) CountInvitedByInviterID(context.Context, int64) (int64, error) {
	panic("unexpected")
}
