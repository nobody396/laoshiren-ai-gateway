export default {
  ...
  topup: {
    ...
    monthlyPlanEnergyValue: '⚡{amount} 能量 / 月',
    monthlyPlanPaygEquivalent: '相当于 ¥{amount} API 按量付费额度',
    monthlyPlanSharedPool: '可用于 GPT 月卡、Cloud 月卡和 Grok 月卡，共用同一份能量额度',
  ...
  feedback: {
    ...
    form: {
      submit: '提交反馈',
      description: '请尽量提供复现步骤、预期结果和截图，方便管理员快速定位。',
      category: '反馈分类',
      titleLabel: '反馈标题',
      content: '反馈内容',
    ...
    edit: {
      title: '编辑反馈',
      description: '修改反馈内容、分类和附件。已关闭的反馈不可编辑。',
      button: '编辑',
      save: '保存修改',
