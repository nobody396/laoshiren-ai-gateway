...
func TestExtractGeminiCLISessionHash(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			body:             `{"contents":[{"parts":[{"text":"The project's temporary directory is: /Users/example-user/.gemini/tmp/f7851b009ed314d1baee62e83115f486160283f4a55a582d89fdac8b9fe3b740"}]}]}`,
...
func TestGeminiCLITmpDirRegex(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input:     "/Users/example-user/.gemini/tmp/f7851b009ed314d1baee62e83115f486160283f4a55a582d89fdac8b9fe3b740",
			wantMatch: true,
			wantHash:  "f7851b009ed314d1baee62e83115f486160283f4a55a582d89fdac8b9fe3b740",
		},
		{
			name:      "valid tmp dir path in text",
			input:     "The project's temporary directory is: /Users/example-user/.gemini/tmp/f7851b009ed314d1baee62e83115f486160283f4a55a582d89fdac8b9fe3b740\nOther text",
			wantMatch: true,
			wantHash:  "f7851b009ed314d1baee62e83115f486160283f4a55a582d89fdac8b9fe3b740",
		},
		{
			name:      "invalid hash length",
			input:     "/Users/example-user/.gemini/tmp/abc123",
			wantMatch: false,
		},
		{
			name:      "no tmp dir",
