...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'gpt-image' | 'grok'
...
const BADGE: Record<Platform, string> = {
  ...
  'gpt-image': 'bg-yellow-500/10 text-yellow-700 border-yellow-500/30 dark:text-yellow-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  'gpt-image': 'bg-yellow-500/10 text-yellow-700 dark:bg-yellow-500/10 dark:text-yellow-300',
...
const BORDER: Record<Platform, string> = {
  ...
  'gpt-image': 'border-yellow-500/20 dark:border-yellow-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  'gpt-image': 'bg-gradient-to-r from-yellow-400 to-yellow-500',
  grok: 'bg-gradient-to-r from-slate-500 to-slate-700',
}
...
const TEXT: Record<Platform, string> = {
  ...
  'gpt-image': 'text-yellow-600 dark:text-yellow-400',
...
const ICON: Record<Platform, string> = {
  ...
  'gpt-image': 'text-yellow-500 dark:text-yellow-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  'gpt-image': 'bg-yellow-500 text-white hover:bg-yellow-600 active:bg-yellow-700 dark:bg-yellow-500/80 dark:hover:bg-yellow-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  'gpt-image': 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  'gpt-image': 'from-yellow-500 to-yellow-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'gpt-image' || p === 'grok'
}
...
export function platformLabel(p: string): string {
  switch (p) {
    ...
    case 'gpt-image': return 'GPT-Image'
