...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			accountchangerecord.Table:     accountchangerecord.ValidColumn,
			accountgroup.Table:            accountgroup.ValidColumn,
			adminapi.Table:                adminapi.ValidColumn,
			adminmenu.Table:               adminmenu.ValidColumn,
			adminrole.Table:               adminrole.ValidColumn,
			adminroleapi.Table:            adminroleapi.ValidColumn,
			adminrolemenu.Table:           adminrolemenu.ValidColumn,
			...
			invoicerequestorder.Table:     invoicerequestorder.ValidColumn,
