...
func (_c *UserCreate) SetAgentID(v int64) *UserCreate {
	_c.mutation.SetAgentID(v)
	return _c
}

// SetNillableAgentID sets the "agent_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableAgentID(v *int64) *UserCreate {
	if v != nil {
		_c.SetAgentID(*v)
	}
	return _c
...
func (_c *UserCreate) SetFirstRecharged(v bool) *UserCreate {
	_c.mutation.SetFirstRecharged(v)
	return _c
}

// SetNillableFirstRecharged sets the "first_recharged" field if the given value is not nil.
func (_c *UserCreate) SetNillableFirstRecharged(v *bool) *UserCreate {
	if v != nil {
		_c.SetFirstRecharged(*v)
	}
	return _c
}

// SetFirstInvitedTopupAt sets the "first_invited_topup_at" field.
func (_c *UserCreate) SetFirstInvitedTopupAt(v time.Time) *UserCreate {
	_c.mutation.SetFirstInvitedTopupAt(v)
	return _c
}

// SetNillableFirstInvitedTopupAt sets the "first_invited_topup_at" field if the given value is not nil.
func (_c *UserCreate) SetNillableFirstInvitedTopupAt(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetFirstInvitedTopupAt(*v)
	}
	return _c
}

// SetFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field.
func (_c *UserCreate) SetFirstInvitedTopupOrderID(v int64) *UserCreate {
	_c.mutation.SetFirstInvitedTopupOrderID(v)
	return _c
}

// SetNillableFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableFirstInvitedTopupOrderID(v *int64) *UserCreate {
	if v != nil {
		_c.SetFirstInvitedTopupOrderID(*v)
	}
	return _c
}
...
func (_c *UserCreate) AddFeedbackIDs(ids ...int64) *UserCreate {
...
func (_c *UserCreate) AddFeedbackReplyIDs(ids ...int64) *UserCreate {
	_c.mutation.AddFeedbackReplyIDs(ids...)
	return _c
}

// AddFeedbackReplies adds the "feedback_replies" edges to the FeedbackReply entity.
func (_c *UserCreate) AddFeedbackReplies(v ...*FeedbackReply) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddFeedbackReplyIDs(ids...)
}
...
func (_c *UserCreate) AddTopupOrderIDs(ids ...int64) *UserCreate {
...
func (_c *UserCreate) AddAccountChangeRecordIDs(ids ...int64) *UserCreate {
	_c.mutation.AddAccountChangeRecordIDs(ids...)
	return _c
}

// AddAccountChangeRecords adds the "account_change_records" edges to the AccountChangeRecord entity.
func (_c *UserCreate) AddAccountChangeRecords(v ...*AccountChangeRecord) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddAccountChangeRecordIDs(ids...)
}

// AddInvoiceProfileIDs adds the "invoice_profiles" edge to the InvoiceProfile entity by IDs.
func (_c *UserCreate) AddInvoiceProfileIDs(ids ...int64) *UserCreate {
	_c.mutation.AddInvoiceProfileIDs(ids...)
	return _c
}

// AddInvoiceProfiles adds the "invoice_profiles" edges to the InvoiceProfile entity.
func (_c *UserCreate) AddInvoiceProfiles(v ...*InvoiceProfile) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) defaults() error {
	...
	if _, ok := _c.mutation.FirstRecharged(); !ok {
		v := user.DefaultFirstRecharged
		_c.mutation.SetFirstRecharged(v)
	}
	return nil
}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.FirstRecharged(); !ok {
		return &ValidationError{Name: "first_recharged", err: errors.New(`ent: missing required field "User.first_recharged"`)}
	}
	return nil
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.FirstRecharged(); ok {
		_spec.SetField(user.FieldFirstRecharged, field.TypeBool, value)
		_node.FirstRecharged = value
	}
	if value, ok := _c.mutation.FirstInvitedTopupAt(); ok {
		_spec.SetField(user.FieldFirstInvitedTopupAt, field.TypeTime, value)
		_node.FirstInvitedTopupAt = &value
	}
	if value, ok := _c.mutation.FirstInvitedTopupOrderID(); ok {
		_spec.SetField(user.FieldFirstInvitedTopupOrderID, field.TypeInt64, value)
		_node.FirstInvitedTopupOrderID = &value
	}
	...
	if nodes := _c.mutation.FeedbackRepliesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.AccountChangeRecordsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
...
// SetAgentID sets the "agent_id" field.
func (u *UserUpsert) SetAgentID(v int64) *UserUpsert {
	u.Set(user.FieldAgentID, v)
	return u
}

// UpdateAgentID sets the "agent_id" field to the value that was provided on create.
func (u *UserUpsert) UpdateAgentID() *UserUpsert {
	u.SetExcluded(user.FieldAgentID)
	return u
}

// AddAgentID adds v to the "agent_id" field.
func (u *UserUpsert) AddAgentID(v int64) *UserUpsert {
	u.Add(user.FieldAgentID, v)
	return u
}

// ClearAgentID clears the value of the "agent_id" field.
func (u *UserUpsert) ClearAgentID() *UserUpsert {
	u.SetNull(user.FieldAgentID)
	return u
}

// SetFirstRecharged sets the "first_recharged" field.
func (u *UserUpsert) SetFirstRecharged(v bool) *UserUpsert {
	u.Set(user.FieldFirstRecharged, v)
	return u
}

// UpdateFirstRecharged sets the "first_recharged" field to the value that was provided on create.
func (u *UserUpsert) UpdateFirstRecharged() *UserUpsert {
	u.SetExcluded(user.FieldFirstRecharged)
	return u
}

// SetFirstInvitedTopupAt sets the "first_invited_topup_at" field.
func (u *UserUpsert) SetFirstInvitedTopupAt(v time.Time) *UserUpsert {
	u.Set(user.FieldFirstInvitedTopupAt, v)
	return u
}

// UpdateFirstInvitedTopupAt sets the "first_invited_topup_at" field to the value that was provided on create.
func (u *UserUpsert) UpdateFirstInvitedTopupAt() *UserUpsert {
	u.SetExcluded(user.FieldFirstInvitedTopupAt)
	return u
}

// ClearFirstInvitedTopupAt clears the value of the "first_invited_topup_at" field.
func (u *UserUpsert) ClearFirstInvitedTopupAt() *UserUpsert {
	u.SetNull(user.FieldFirstInvitedTopupAt)
	return u
}

// SetFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field.
func (u *UserUpsert) SetFirstInvitedTopupOrderID(v int64) *UserUpsert {
	u.Set(user.FieldFirstInvitedTopupOrderID, v)
	return u
}

// UpdateFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field to the value that was provided on create.
func (u *UserUpsert) UpdateFirstInvitedTopupOrderID() *UserUpsert {
	u.SetExcluded(user.FieldFirstInvitedTopupOrderID)
	return u
}

// AddFirstInvitedTopupOrderID adds v to the "first_invited_topup_order_id" field.
func (u *UserUpsert) AddFirstInvitedTopupOrderID(v int64) *UserUpsert {
	u.Add(user.FieldFirstInvitedTopupOrderID, v)
	return u
}

// ClearFirstInvitedTopupOrderID clears the value of the "first_invited_topup_order_id" field.
func (u *UserUpsert) ClearFirstInvitedTopupOrderID() *UserUpsert {
	u.SetNull(user.FieldFirstInvitedTopupOrderID)
	return u
}
...
// SetAgentID sets the "agent_id" field.
func (u *UserUpsertOne) SetAgentID(v int64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetAgentID(v)
	})
}
...
// AddAgentID adds v to the "agent_id" field.
func (u *UserUpsertOne) AddAgentID(v int64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.AddAgentID(v)
	})
}
...
// UpdateAgentID sets the "agent_id" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateAgentID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAgentID()
	})
}
...
// ClearAgentID clears the value of the "agent_id" field.
func (u *UserUpsertOne) ClearAgentID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearAgentID()
	})
}
...
// SetFirstRecharged sets the "first_recharged" field.
func (u *UserUpsertOne) SetFirstRecharged(v bool) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstRecharged(v)
	})
}

// UpdateFirstRecharged sets the "first_recharged" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateFirstRecharged() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstRecharged()
	})
}

// SetFirstInvitedTopupAt sets the "first_invited_topup_at" field.
func (u *UserUpsertOne) SetFirstInvitedTopupAt(v time.Time) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstInvitedTopupAt(v)
	})
}

// UpdateFirstInvitedTopupAt sets the "first_invited_topup_at" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateFirstInvitedTopupAt() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstInvitedTopupAt()
	})
}

// ClearFirstInvitedTopupAt clears the value of the "first_invited_topup_at" field.
func (u *UserUpsertOne) ClearFirstInvitedTopupAt() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearFirstInvitedTopupAt()
	})
}

// SetFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field.
func (u *UserUpsertOne) SetFirstInvitedTopupOrderID(v int64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstInvitedTopupOrderID(v)
	})
}

// AddFirstInvitedTopupOrderID adds v to the "first_invited_topup_order_id" field.
func (u *UserUpsertOne) AddFirstInvitedTopupOrderID(v int64) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.AddFirstInvitedTopupOrderID(v)
	})
}

// UpdateFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateFirstInvitedTopupOrderID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstInvitedTopupOrderID()
	})
}

// ClearFirstInvitedTopupOrderID clears the value of the "first_invited_topup_order_id" field.
func (u *UserUpsertOne) ClearFirstInvitedTopupOrderID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearFirstInvitedTopupOrderID()
	})
}
...
// SetAgentID sets the "agent_id" field.
func (u *UserUpsertBulk) SetAgentID(v int64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetAgentID(v)
	})
}
...
// AddAgentID adds v to the "agent_id" field.
func (u *UserUpsertBulk) AddAgentID(v int64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.AddAgentID(v)
	})
}
...
// UpdateAgentID sets the "agent_id" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateAgentID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAgentID()
	})
}
...
// ClearAgentID clears the value of the "agent_id" field.
func (u *UserUpsertBulk) ClearAgentID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearAgentID()
	})
}
...
// SetFirstRecharged sets the "first_recharged" field.
func (u *UserUpsertBulk) SetFirstRecharged(v bool) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstRecharged(v)
	})
}
...
// UpdateFirstRecharged sets the "first_recharged" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateFirstRecharged() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstRecharged()
	})
}
...
// SetFirstInvitedTopupAt sets the "first_invited_topup_at" field.
func (u *UserUpsertBulk) SetFirstInvitedTopupAt(v time.Time) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstInvitedTopupAt(v)
	})
}
...
// UpdateFirstInvitedTopupAt sets the "first_invited_topup_at" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateFirstInvitedTopupAt() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstInvitedTopupAt()
	})
}
...
// ClearFirstInvitedTopupAt clears the value of the "first_invited_topup_at" field.
func (u *UserUpsertBulk) ClearFirstInvitedTopupAt() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearFirstInvitedTopupAt()
	})
}
...
// SetFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field.
func (u *UserUpsertBulk) SetFirstInvitedTopupOrderID(v int64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetFirstInvitedTopupOrderID(v)
	})
}
...
// AddFirstInvitedTopupOrderID adds v to the "first_invited_topup_order_id" field.
func (u *UserUpsertBulk) AddFirstInvitedTopupOrderID(v int64) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.AddFirstInvitedTopupOrderID(v)
	})
}
...
// UpdateFirstInvitedTopupOrderID sets the "first_invited_topup_order_id" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateFirstInvitedTopupOrderID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateFirstInvitedTopupOrderID()
	})
}
...
// ClearFirstInvitedTopupOrderID clears the value of the "first_invited_topup_order_id" field.
func (u *UserUpsertBulk) ClearFirstInvitedTopupOrderID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearFirstInvitedTopupOrderID()
	})
}
