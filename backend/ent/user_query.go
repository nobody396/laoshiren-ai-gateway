...
type UserQuery struct {
	...
	withFeedbackReplies       *FeedbackReplyQuery
	...
	withAccountChangeRecords  *AccountChangeRecordQuery
	withInvoiceProfiles       *InvoiceProfileQuery
...
// QueryFeedbackReplies chains the current query on the "feedback_replies" edge.
func (_q *UserQuery) QueryFeedbackReplies() *FeedbackReplyQuery {
...
// QueryTopupOrders chains the current query on the "topup_orders" edge.
...
// QueryAccountChangeRecords chains the current query on the "account_change_records" edge.
func (_q *UserQuery) QueryAccountChangeRecords() *AccountChangeRecordQuery {
	query := (&AccountChangeRecordClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryInvoiceProfiles chains the current query on the "invoice_profiles" edge.
func (_q *UserQuery) QueryInvoiceProfiles() *InvoiceProfileQuery {
	query := (&InvoiceProfileClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withFeedbackReplies:       _q.withFeedbackReplies.Clone(),
		...
		withAccountChangeRecords:  _q.withAccountChangeRecords.Clone(),
...
// WithFeedbackReplies tells the query-builder to eager-load the nodes that are connected to
// the "feedback_replies" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithFeedbackReplies(opts ...func(*FeedbackReplyQuery)) *UserQuery {
	query := (&FeedbackReplyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withFeedbackReplies = query
	return _q
}
...
// the "topup_orders" edge. The optional arguments are used to configure the query builder of the edge.
...
// WithAccountChangeRecords tells the query-builder to eager-load the nodes that are connected to
// the "account_change_records" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAccountChangeRecords(opts ...func(*AccountChangeRecordQuery)) *UserQuery {
	query := (&AccountChangeRecordClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAccountChangeRecords = query
	return _q
}

// WithInvoiceProfiles tells the query-builder to eager-load the nodes that are connected to
// the "invoice_profiles" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithInvoiceProfiles(opts ...func(*InvoiceProfileQuery)) *UserQuery {
	query := (&InvoiceProfileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withInvoiceProfiles = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [19]bool{
			...
			_q.withAccountChangeRecords != nil,
	...
	if query := _q.withFeedbackReplies; query != nil {
		if err := _q.loadFeedbackReplies(ctx, query, nodes,
			func(n *User) { n.Edges.FeedbackReplies = []*FeedbackReply{} },
			func(n *User, e *FeedbackReply) { n.Edges.FeedbackReplies = append(n.Edges.FeedbackReplies, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAccountChangeRecords; query != nil {
		if err := _q.loadAccountChangeRecords(ctx, query, nodes,
			func(n *User) { n.Edges.AccountChangeRecords = []*AccountChangeRecord{} },
			func(n *User, e *AccountChangeRecord) {
				n.Edges.AccountChangeRecords = append(n.Edges.AccountChangeRecords, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withInvoiceProfiles; query != nil {
		if err := _q.loadInvoiceProfiles(ctx, query, nodes,
			func(n *User) { n.Edges.InvoiceProfiles = []*InvoiceProfile{} },
			func(n *User, e *InvoiceProfile) { n.Edges.InvoiceProfiles = append(n.Edges.InvoiceProfiles, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadFeedbackReplies(ctx context.Context, query *FeedbackReplyQuery, nodes []*User, init func(*User), assign func(*User, *FeedbackReply)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(feedbackreply.FieldUserID)
	}
	query.Where(predicate.FeedbackReply(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.FeedbackRepliesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadAccountChangeRecords(ctx context.Context, query *AccountChangeRecordQuery, nodes []*User, init func(*User), assign func(*User, *AccountChangeRecord)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(accountchangerecord.FieldUserID)
	}
	query.Where(predicate.AccountChangeRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AccountChangeRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadInvoiceProfiles(ctx context.Context, query *InvoiceProfileQuery, nodes []*User, init func(*User), assign func(*User, *InvoiceProfile)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(invoiceprofile.FieldUserID)
	}
	query.Where(predicate.InvoiceProfile(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.InvoiceProfilesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
