...
export type ClientSetupTarget = 'claude' | 'codex' | 'grok' | 'gemini' | 'kimi' | 'opencode' | 'zcode' | 'workbuddy'
...
export interface ClientSetupOption {
  client_id: 'codex' | 'claude-code' | 'grok-build' | 'kimi-code' | 'opencode' | 'zcode' | 'workbuddy'
  name: string
}
