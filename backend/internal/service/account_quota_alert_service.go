...
// AccountQuotaAlertService handles account quota threshold notifications.
type AccountQuotaAlertService struct {
	emailService *EmailService
	settingRepo  SettingRepository
	accountRepo  AccountQuotaReader
}

// NewAccountQuotaAlertService creates a new AccountQuotaAlertService.
func NewAccountQuotaAlertService(emailService *EmailService, settingRepo SettingRepository, accountRepo AccountQuotaReader) *AccountQuotaAlertService {
	return &AccountQuotaAlertService{
		emailService: emailService,
...
func (s *AccountQuotaAlertService) CheckAccountQuotaAfterIncrement(ctx context.Context, account *Account, cost float64, quotaState *AccountQuotaState) {
...
func (s *AccountQuotaAlertService) fetchFreshAccount(ctx context.Context, snapshot *Account) *Account {
...
func (s *AccountQuotaAlertService) checkQuotaDimCrossings(account *Account, dims []quotaDim, cost float64, adminEmails []string, siteName string) {
...
func (s *AccountQuotaAlertService) asyncSendQuotaAlert(adminEmails []string, accountID int64, accountName, platform string, dim quotaDim, newUsed, effectiveThreshold float64, siteName string) {
	go func() {
		defer func() {
			if r := recover(); r != nil {
...
func (s *AccountQuotaAlertService) isAccountQuotaNotifyEnabled(ctx context.Context) bool {
...
func (s *AccountQuotaAlertService) getAccountQuotaNotifyEmails(ctx context.Context) []string {
...
func (s *AccountQuotaAlertService) getSiteName(ctx context.Context) string {
...
func (s *AccountQuotaAlertService) sendEmails(recipients []string, subject, body string, logAttrs ...any) {
	if len(recipients) == 0 {
...
func (s *AccountQuotaAlertService) sendQuotaAlertEmails(adminEmails []string, accountID int64, accountName, platform string, dim quotaDim, used float64, siteName string) {
...
func (s *AccountQuotaAlertService) buildQuotaAlertEmailBody(accountID int64, accountName, platform, dimLabel string, used, limit, remaining float64, thresholdDisplay, siteName string) string {
