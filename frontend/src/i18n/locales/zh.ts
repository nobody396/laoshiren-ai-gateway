export default {
  ...
  keys: {
    ...
    ccsClientSelect: {
      ...
      compatibilityNote: '这里只展示与当前分组协议兼容的工具，避免导入成功但请求无法使用。Grok Build 需要 CC Switch 3.18.0 或更高版本；OpenClaw 和 Hermes 需要 3.16.5 或更高版本。',
      ...
      grokBuildDesc: '使用 Grok 原生 Responses 协议导入',
      opencode: 'OpenCode',
  ...
  nativeCheckout: {
    ...
    trialDescription: '支付 1 元，到账 5 元体验赠送额度。',
    registeredEmail: '下单将自动使用当前账号的注册邮箱，无需再次填写。',
    pay: '实付',
    receive: '到账赠送额度',
    preparing: '正在准备支付…',
    claimed: '体验额度已领取',
    ...
    completedHint: '¥{amount} 体验赠送额度已到账。',
    wechatPay: '微信支付',
    alipayPay: '支付宝支付',
    qrPayment: '扫码支付',
    ...
    providerExpiryHint: '支付渠道未返回明确失效时间，二维码实际有效期以微信或支付宝支付页为准。',
    automaticEta: '通常付款且发码后约 3–15 秒自动到账；如发码延迟，页面会继续自动核对。',
    creatingOrder: '正在创建订单，请稍候…',
    creditingHint: '支付已确认，正在自动发放额度…',
    paymentCompleted: '支付成功，额度已到账',
    waitingPayment: '等待支付，支付完成后将自动到账',
    doNotRepeat: '请只支付一次；无需复制卡密或手动兑换。',
    createFailed: '暂时无法创建体验订单，请稍后重试',
    qrUnavailable: '暂时无法获取支付二维码，请稍后重试',
    completedToast: '支付成功，¥{amount} 体验赠送额度已到账',
  },
  topup: {
    title: '充值',
    buttonLabel: '充值',
