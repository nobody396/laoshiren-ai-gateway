  ...
  admin: {
    ...
    ops: {
      ...
      webhook: {
        ...
        dingtalkTitle: '钉钉告警群',
        dingtalkHint: '在钉钉群添加自定义机器人后，把机器人 Webhook 填在这里。建议安全设置选择加签。',
        ...
        dingtalkWebhookUrl: '钉钉 Webhook',
        dingtalkSignSecret: '钉钉加签密钥',
        dingtalkSignSecretHint: '钉钉机器人未开启加签时可留空；若启用关键词，建议包含“老实人AI”。',
        ...
        validation: {
          ...
          dingtalkWebhookRequired: '开启钉钉通知时必须填写钉钉 Webhook',
