...
export const teamAPI = {
  ...
  async setStatus(status: 'active' | 'suspended'): Promise<TeamContext> {
  ...
  async updateLimits(userID: number, limits: { daily_limit_usd: number; weekly_limit_usd: number; monthly_limit_usd: number }): Promise<void> {
