...
// GptImageCallPrice applies equality check predicate on the "gpt_image_call_price" field. It's identical to GptImageCallPriceEQ.
func GptImageCallPrice(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldGptImageCallPrice, v))
}
...
// GptImageCallPriceEQ applies the EQ predicate on the "gpt_image_call_price" field.
func GptImageCallPriceEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldGptImageCallPrice, v))
}

// GptImageCallPriceNEQ applies the NEQ predicate on the "gpt_image_call_price" field.
func GptImageCallPriceNEQ(v float64) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldGptImageCallPrice, v))
}

// GptImageCallPriceIn applies the In predicate on the "gpt_image_call_price" field.
func GptImageCallPriceIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldGptImageCallPrice, vs...))
}

// GptImageCallPriceNotIn applies the NotIn predicate on the "gpt_image_call_price" field.
func GptImageCallPriceNotIn(vs ...float64) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldGptImageCallPrice, vs...))
}

// GptImageCallPriceGT applies the GT predicate on the "gpt_image_call_price" field.
func GptImageCallPriceGT(v float64) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldGptImageCallPrice, v))
}

// GptImageCallPriceGTE applies the GTE predicate on the "gpt_image_call_price" field.
func GptImageCallPriceGTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldGptImageCallPrice, v))
}

// GptImageCallPriceLT applies the LT predicate on the "gpt_image_call_price" field.
func GptImageCallPriceLT(v float64) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldGptImageCallPrice, v))
}

// GptImageCallPriceLTE applies the LTE predicate on the "gpt_image_call_price" field.
func GptImageCallPriceLTE(v float64) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldGptImageCallPrice, v))
}

// GptImageCallPriceIsNil applies the IsNil predicate on the "gpt_image_call_price" field.
func GptImageCallPriceIsNil() predicate.Group {
	return predicate.Group(sql.FieldIsNull(FieldGptImageCallPrice))
}

// GptImageCallPriceNotNil applies the NotNil predicate on the "gpt_image_call_price" field.
func GptImageCallPriceNotNil() predicate.Group {
	return predicate.Group(sql.FieldNotNull(FieldGptImageCallPrice))
}
...
func HasAccountChangeRecords() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAccountChangeRecordsWith(preds ...predicate.AccountChangeRecord) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
