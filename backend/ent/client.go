...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.SecuritySecret, c.Setting, c.TLSFingerprintProfile, c.Team, c.TeamInvitation,
		c.TeamMembership, c.TeamOwnershipTransfer, c.TopupOrder, c.UsageCleanupTask,
		c.UsageLog, c.User, c.UserAllowedGroup, c.UserAttributeDefinition,
		c.UserAttributeValue, c.UserNotification, c.UserSubscription,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		SecuritySecret, Setting, TLSFingerprintProfile, Team, TeamInvitation,
		TeamMembership, TeamOwnershipTransfer, TopupOrder, UsageCleanupTask, UsageLog,
