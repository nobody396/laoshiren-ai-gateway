...
func init() {
	...
	usagelogDescImageOutputTokens := usagelogFields[22].Descriptor()
	...
	usagelogDescImageOutputCost := usagelogFields[29].Descriptor()
	...
	usagelogDescMediaType := usagelogFields[41].Descriptor()
