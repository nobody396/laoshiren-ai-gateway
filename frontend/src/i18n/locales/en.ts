export default {
  ...
  nativeCheckout: {
    ...
    trialDescription: 'Pay ¥1 and receive ¥5 in trial gift credit.',
    registeredEmail: 'Your registered account email is used automatically. No form is required.',
    pay: 'Pay',
    receive: 'Gift credit',
    preparing: 'Preparing payment…',
    claimed: 'Trial credit claimed',
    reviewing: 'Order being checked',
    continuePayment: 'Continue payment',
    crediting: 'Crediting…',
    buyNow: 'Try now for ¥1',
    checkingHint: 'This order is being checked. Do not pay again; credit will be applied automatically after confirmation.',
    completedHint: '¥{amount} in trial gift credit has been applied.',
    ...
    providerExpiryHint: 'The payment channel does not return an exact expiry. The WeChat or Alipay payment page is authoritative.',
    automaticEta: 'Credit usually arrives 3–15 seconds after payment and code delivery. Delayed delivery keeps checking automatically.',
    ...
    doNotRepeat: 'Pay only once. No code copying or manual redemption is needed.',
    ...
    completedToast: 'Payment complete. ¥{amount} in trial gift credit was applied.',
  },
  topup: {
    title: 'Top Up',
    buttonLabel: 'Top Up',
