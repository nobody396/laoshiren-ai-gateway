...
type OpenAIRouteShadowAuditCandidate struct {
	...
	LegacyObservationSamples             uint64                       `json:"legacy_observation_samples,omitempty"`
	LegacySuccessLowerBound              float64                      `json:"legacy_success_lower_bound,omitempty"`
	ReliabilityEvidenceSamples           uint64                       `json:"reliability_evidence_samples,omitempty"`
	ReliabilityEvidenceSuccessLowerBound float64                      `json:"reliability_evidence_success_lower_bound,omitempty"`
	ReliabilityEvidenceApplied           bool                         `json:"reliability_evidence_applied,omitempty"`
...
type OpenAIRouteShadowAuditSnapshot struct {
	...
	ReliabilityEvidenceAdapterEnabled  bool                                 `json:"reliability_evidence_adapter_enabled,omitempty"`
	ReliabilityEvidenceAdapterApplied  bool                                 `json:"reliability_evidence_adapter_applied,omitempty"`
	ReliabilityEvidenceAdapterReason   string                               `json:"reliability_evidence_adapter_reason,omitempty"`
	ReliabilityEvidenceAdapterSamples  uint64                               `json:"reliability_evidence_adapter_samples,omitempty"`
	ReliabilityEvidencePendingCutoffID uint64                               `json:"reliability_evidence_pending_cutoff_id,omitempty"`
}
