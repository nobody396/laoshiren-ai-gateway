export default {
  ...
  topup: {
    ...
    monthlyPlanStatus: 'Sold out',
    monthlyPlanHint: 'Developer monthly cards are being restocked. Pricing, daily credits, and shared quota rules are visible now.',
    monthlyPlanPrice: 'Monthly price',
    monthlyPlanCredits: 'Daily credits',
    monthlyPlanTotalCredits: '30-day credits',
