...
func TestDashboardRawErrorCountsExcludeMonthlyUpstreamProbeFromSLA(t *testing.T) {
	...
	total, business, sla, upstream, rateLimited, overloaded, err := repo.queryErrorCounts(context.Background(), nil, start, end)
	if err != nil {
