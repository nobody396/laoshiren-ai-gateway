...
Try Sub2API online: **https://demo.example.com/**
...
```bash
curl -sSL https://raw.githubusercontent.com/bozhouDev/DragonCode-sub2api/main/deploy/install.sh | sudo bash
```
...
# Uninstall
curl -sSL https://raw.githubusercontent.com/bozhouDev/DragonCode-sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/bozhouDev/DragonCode-sub2api/main/deploy/docker-deploy.sh | bash
...
git clone https://github.com/bozhouDev/DragonCode-sub2api.git
cd sub2api/deploy
...
Set the initial admin password in `.env` before the first startup:
```bash
ADMIN_PASSWORD=your_admin_password
```
...
<a href="https://star-history.com/#bozhouDev/DragonCode-sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=bozhouDev/DragonCode-sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=bozhouDev/DragonCode-sub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=bozhouDev/DragonCode-sub2api&type=Date" />
 </picture>
</a>
