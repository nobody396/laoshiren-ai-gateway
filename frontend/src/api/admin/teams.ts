...
import type { TeamContext, TeamMembership, TeamUsageQuery, TeamUsageSummary } from '../team'
...
const teamsAPI = {
  ...
  async update(id: number, payload: { name?: string; status?: 'active' | 'suspended'; member_limit?: number }): Promise<TeamContext> {
