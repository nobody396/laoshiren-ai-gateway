...
import (
	...
	"github.com/bozhouDev/DragonCode-sub2api/internal/pkg/websearch"
...
// ShouldEmulateWebSearch exposes the web-search interception decision to callers outside service.
func (s *GatewayService) ShouldEmulateWebSearch(ctx context.Context, account *Account, groupID *int64, body []byte) bool {
	return s.shouldEmulateWebSearch(ctx, account, groupID, body)
}

// HandleWebSearchEmulation exposes the web-search emulation handler to callers outside service.
