export default {
  ...
  agent: {
    ...
    paymentProfile: '收款信息',
    paymentProfileHint: '用于管理员人工扫码结算，未结算佣金达到起结门槛后即可结算',
  ...
  admin: {
    ...
    agents: {
      title: '代理商管理',
      description: '管理代理商分润、邀请用户、比例配置和结算记录',
      search: '搜索代理商',
      ...
      runThisAgentLevelEvaluation: '重跑该代理评档',
      level_light: '轻代理',
      level_standard: '标准代理',
      level_core: '核心代理',
      level_super: '超级代理',
      ...
      overwriteAgentBinding: '如果用户已属于其他代理商，则覆盖当前归属',
      settle: '结算余额',
      ...
      agentLevelEvaluationCompleted: '该代理评档已完成',
      agentRateUpdated: '代理商比例已更新',
      userBound: '已绑定用户 {email}',
      userRebound: '已改绑用户 {email}',
      userAlreadyBound: '用户 {email} 已在该代理商名下',
      settlementCreated: '结算记录已创建',
      failedToLoad: '加载代理商数据失败',
      failedToSave: '保存代理商配置失败',
      failedToRunLevelEvaluation: '执行代理评档失败',
    ...
    users: {
      ...
      setAsAgent: '设为代理商',
      setAsLightAgent: '设为轻代理 (5%)',
      setAsStandardAgent: '设为标准代理 (10%)',
      removeAgent: '撤销代理商',
      setAsAgentSuccess: '已将用户设为代理商',
      setAsLightAgentSuccess: '已将用户设为轻代理',
      setAsStandardAgentSuccess: '已将用户设为标准代理',
      removeAgentSuccess: '已撤销代理商角色',
