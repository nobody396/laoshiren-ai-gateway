export default {
  ...
  usageReceipt: {
    ...
    inviteReady: 'The QR code is linked to your personal invite URL',
    ...
    sharePayloadText: 'Here is my AI usage receipt. Scan it to join me on LaoshirenAI.',
