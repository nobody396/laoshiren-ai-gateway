...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	agentHandler := handler.NewAgentHandler(commissionService, affiliateLinkService, affiliateAgentService, affiliateCommunityService)
	...
	adminAgentHandler := admin.NewAgentHandler(commissionService, affiliateCommunityService)
