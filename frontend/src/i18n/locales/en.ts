export default {
  ...
  home: {
    ...
    heroTitle2: 'One-Stop AI Gateway',
    heroDescription: 'No coding required — turn ideas into reality with natural language! Quickly set up stable, secure, and affordable',
    heroDescriptionEnd: ', and experience the world\'s top AI coding tools. Boost productivity by',
    heroEfficiency: '300%',
    heroCta: 'Get Started Free',
    heroCtaSecondary: 'Join Community',
    heroBadge: 'Get Free Credits',
    heroStats: {
      users: '10000+',
      usersLabel: 'Subscribers',
      companies: '200+',
      companiesLabel: 'Enterprise & University',
      days: '280+',
      daysLabel: 'Days of Stable Service'
    },
    tags: {
    ...
    // Pricing section
    pricing: {
      sectionLabel: 'PLAN BUNDLES',
      title: 'Plan Pricing for Developers at',
      titleHighlight: 'Every Stage',
      subtitle: 'We offer affordable subscription plans for regular developers.',
      disclaimer: '* The above plans are for illustrative purposes only. Actual prices and benefits are subject to the console "Subscription" page and official announcements.',
      ...
      plans: {
        paygo: {
          ...
          badge: 'Flexible',
          name: 'PAYGO Plan',
          description: 'Pay as you go, one-time quota purchase, credits never expire.',
          price: '$9.90',
          priceUnit: '/ from $165',
          features: [
            'Access mainstream Claude / Codex coding models',
            'Ideal for light usage, start and stop anytime',
            'Up to $165 Claude or $330 Codex credits'
          ]
        },
        monthly: {
          category: 'Monthly',
          badge: 'Most Popular',
          name: 'Monthly Plan',
          description: 'Monthly billing with daily fixed quota, credits do not roll over.',
          price: '$29.00',
          priceUnit: '/ month',
          features: [
            'Access mainstream Claude / Codex coding models',
            '$40/day Claude or $80/day Codex quota',
            'Can be used alongside PAYGO plan'
          ]
        },
        enterprise: {
          category: 'Enterprise / Team',
          badge: 'Custom',
          name: 'Custom Plan',
          description: 'For teams requiring concurrency, budget control, and centralized management.',
          price: 'Custom Pricing',
          priceUnit: '',
          features: [
            'Advanced audit support for team usage',
            'Dedicated high-throughput channels, zero latency',
            'Exclusive technical support and onboarding'
          ],
          contactLink: 'Contact sales for custom quote'
        }
      }
    },
    // CTA section
  ...
  setup: {
    title: '老实人 AI Setup',
    description: 'Configure your 老实人 AI instance',
    database: {
  ...
  common: {
    ...
    techSupportDesc: 'Handles installation and environment setup issues',
    delete: 'Delete',
    edit: 'Edit',
    create: 'Create',
    update: 'Update',
    ...
    notAvailable: 'N/A',
    permissionDenied: 'You do not have permission to access this feature. Please contact an administrator.',
  ...
  nav: {
    ...
    agentConsole: 'Partner Center',
    agentManagement: 'Partner Management',
    affiliateCenter: 'Affiliate Program',
    affiliateOperations: 'Affiliate Operations',
    agentDashboard: 'Partner Dashboard',
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive ⚡${amount} platform credit',
    ...
    referralCodePlaceholder: 'Enter invite code (optional)',
    referralCodeHint: 'Enter your referrer’s invite code; after your first real purchase, both of you receive 5% as ⚡ credit',
    linuxdo: {
      ...
      bindingSuccess: 'Linux.do account linked successfully',
      bindingConflict: 'This Linux.do account is already linked to another user',
      bindingFailed: 'Failed to link Linux.do account',
      stateExpired: 'This authorization has expired. Please start again.',
      stateConsumed: 'This authorization has already been used. Please start again.',
      invalidState: 'Invalid authorization state. Please start again.',
      missingVerifier: 'Missing PKCE verifier. Please start again.',
      providerError: 'Linux.do returned an authorization error',
      tokenExchangeFailed: 'Failed to exchange Linux.do authorization code',
      userInfoFailed: 'Failed to fetch Linux.do user info',
      loginFailed: 'Linux.do sign-in failed. Please try again.'
    },
	    oauth: {
	      code: 'Code',
	      state: 'State',
	      ...
	      callbackMissingToken: 'Missing login token, please try again.',
	      backToLogin: 'Back to Login',
	      invitationRequired: 'This {provider} account is not yet registered. The site requires an invitation code, please enter one to complete registration.',
	      referralOptional: 'This {provider} account is not registered yet. If you have an invite code, enter it before continuing; otherwise you can skip it.',
	      invalidPendingToken: 'The registration token has expired. Please start third-party sign-in again.',
	      completeRegistration: 'Complete Registration',
	      completing: 'Completing registration...',
	      completeRegistrationFailed: 'Registration failed. Please check your invitation code and try again.',
	      skipReferral: 'Skip invite code',
	      bindingSuccess: '{provider} account linked successfully',
	      bindingConflict: 'This third-party account is already linked to another user',
	      bindingFailed: 'Failed to link account',
	      stateExpired: 'This authorization has expired. Please start again.',
	      stateConsumed: 'This authorization has already been used. Please start again.',
	      invalidState: 'Invalid authorization state. Please start again.',
	      missingVerifier: 'Missing PKCE verifier. Please start again.',
	      providerError: '{provider} returned an authorization error',
	      tokenExchangeFailed: 'Failed to exchange {provider} authorization code',
	      userInfoFailed: 'Failed to fetch {provider} user info',
	      loginFailed: '{provider} sign-in failed. Please try again.'
	    },
    oauthCallbackTitle: 'Signing in',
    // Forgot password
  ...
  // Agent (Long-term Revenue Share System)
  agent: {
    dashboard: 'Partner Dashboard',
    dateRange: 'Date Range',
    allTime: 'All Time',
    totalCommission: 'Total Revenue Share',
    settledCommission: 'Settled Revenue Share',
    unsettledCommission: 'Unsettled Revenue Share',
    thisMonthCommission: 'This Month',
    periodCommission: 'Period Revenue Share',
    currentRate: 'Current Rate',
    agentLevel: 'Partner Level',
    ...
    upgradeAtAssessment: 'Will upgrade automatically at {time}',
    upgradeAfterTargetAtAssessment: 'If qualified, upgrade runs automatically at {time}',
    monthlyProgress: 'Monthly Assessment Progress',
    cumulativeProgress: 'Permanent Progress',
    targetLevelWithRate: '{level} / {rate}',
    maxLevelReached: 'Highest level reached',
    thisMonthPerformance: 'This Month',
    totalPerformance: 'Total Performance',
    targetPerformance: 'Target',
    performanceGap: 'Gap',
    levelLight: 'Light Partner',
    levelStandard: 'Standard Partner',
    levelCore: 'Core Partner',
    levelSuper: 'Super Partner',
    levelManual: 'Manual Base',
    invitedUsers: 'Invited Users',
    invitedUsersDesc: 'View direct users’ paid entitlements, confirmed usage, and commission; monthly plans use entitlement value and newcomer usage earns no commission',
    userLabel: 'User',
    ...
    inviteCodeHintWithRate: 'This legacy code now uses your default partner link. Open Alliance Center to set the dynamic rebate and copy your campaign link.',
    ...
    viewCommissionsDesc: 'Detailed revenue share history filtered by type and date',
    joinedAt: 'Joined At',
    totalRecharge: 'Paid Entitlements',
    totalConsumption: 'Confirmed Consumption',
    noInvitedUsers: 'No invited users yet',
    commissionRecords: 'Revenue Share Records',
    commissionType: 'Type',
    triggeredBy: 'User',
    sourceAmount: 'Source Amount',
    commissionAmount: 'Revenue Share',
    noCommissions: 'No revenue share records yet',
    allTypes: 'All Types',
    typeConsumption: 'API Long-term Revenue Share',
    typeSelfConsumption: 'Own Usage Revenue Share',
    typeFirstRechargeInvitee: 'Invite Bonus (Invitee)',
    typeFirstRechargeFriendInvitee: 'Invite Bonus (Friend Invitee)',
    typeFirstRechargeReferral: 'Invite Bonus (Referral)',
    type_consumption: 'API Long-term Revenue Share',
    type_consumption_commission: 'API Long-term Revenue Share',
    type_self_consumption_commission: 'Own Usage Revenue Share',
    type_consumption_reversal: 'Consumption Reversal',
    type_first_recharge_invitee: 'Invite Bonus (Invitee)',
    type_first_recharge_invitee_bonus: 'Invite Bonus (Invitee)',
    type_first_recharge_friend_invitee: 'Invite Bonus (Friend Invitee)',
    type_first_recharge_friend_invitee_bonus: 'Invite Bonus (Friend Invitee)',
    type_first_recharge_referral: 'Invite Bonus (Referral)',
    type_first_recharge_referral_bonus: 'Invite Bonus (Referral)',
    type_invite_activity_registration_bonus: 'Timed Campaign Registration Bonus',
    selfConsumptionTrigger: 'Own Usage',
    paymentProfile: 'Payment Info',
    paymentProfileHint: 'Used for manual payout by admin. Settlement is available after unpaid commission reaches the minimum.',
    settlementMinimum: 'Minimum',
    settlementStatus: 'Settlement Status',
    settlementProgress: 'Progress',
    settlementEligible: 'Ready to settle',
    settlementBelowMinimum: 'Below minimum',
    settlementReady: 'Minimum reached',
    settlementGap: '{amount} remaining',
    paymentProfileIncomplete: 'Payment info incomplete',
    alipayRealName: 'Alipay Name',
    alipayRealNamePlaceholder: 'Must match Alipay real name',
    alipayAccount: 'Alipay Account',
    alipayAccountPlaceholder: 'Phone or email',
  ...
  user: {
    ...
    referral: {
      ...
      boundAgent: 'You registered via a partner invite code',
      boundUser: 'You registered via a friend\'s invite code',
      notBound: 'You have not used an invite code',
      firstRechargeReceived: 'First-purchase invite reward received',
      firstRechargePending: 'Complete your first real purchase to claim the reward',
      myInviteCode: 'My Invite Code & Invite Link',
      inviteHint: 'Invite friends to register. When they make their first top-up, both of you can receive the configured invite bonus.',
      inviteHintWithRates: 'Invite friends to register. When they make their first top-up, you receive {referralRate} of the top-up amount and their account balance increases by {inviteeRate}.',
      invitedCount: 'Invited Users',
      totalCommission: 'Total Invite Bonus',
      thisMonthCommission: 'This Month',
    },
  },
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      gptImage: {
        description: 'GPT-Image uses a dedicated asynchronous image gateway. Set the Base URL to your site /gpt-image/v1, submit a generation task, then poll /tasks/{task_id} for the final image.',
        note: 'This gateway is fixed to model gpt-image-2 and only supports n=1. Use aspect ratios for size, such as 1:1 or 16:9. resolution supports 1k, 2k, and 4k, and billing uses the matching group resolution price.',
        endpointHint: 'Base URL: {baseUrl}, submit endpoint: POST /images/generations; size is an aspect ratio, resolution is 1k / 2k / 4k',
        pollHint: 'A successful submit response returns task_id. Replace task_xxx with the actual task_id, then read data.result.images[0].url[0] after completed.',
      },
      antigravity: {
    ...
    ccsClientSelect: {
      ...
      compatibilityNote: 'Only apps compatible with this group protocol are shown. Grok Build uses a one-time setup compatible with official CC Switch 3.19.2; OpenClaw and Hermes require 3.16.5 or later.',
      ...
      codexStandard: 'Codex · Standard 272K',
      codexStandardDesc: '272K window with compaction at 258K for everyday tasks',
      codexLong: 'Codex · Long Context 1M',
      codexLongDesc: '1M window with compaction at 900K; long-context tiered pricing applies above 272K',
      ...
      openclaw: 'OpenClaw',
      openclawDesc: 'Uses an OpenAI-compatible protocol',
      hermes: 'Hermes Agent',
      hermesDesc: 'Uses the Chat Completions protocol',
      geminiCli: 'Gemini CLI',
  ...
  usageReceipt: {
    eyebrow: 'SHARE YOUR AI JOURNEY',
    title: 'My AI Receipt',
    description: 'Print your real spend, tokens, and model breakdown as a LaoshirenAI receipt ready to share. The QR code uses your personal invite link.',
    backToUsage: 'Back to usage',
    settingsLabel: 'Receipt settings',
    periodTitle: 'Choose a period',
    periodHint: 'Receipt figures come directly from your usage records',
    ...
    showModels: 'Show model details',
    showModelsHint: 'Only model, requests, tokens, and billed amount are shown',
    safeByDefault: 'Receipts never include API keys, request contents, IP addresses, email, or login information.',
    shareTitle: 'Save and share',
    ordinaryInviteReady: 'The QR code uses your personal invite URL',
    partnerInviteReady: 'The QR code uses your affiliate commission URL',
    inviteFallback: 'Invite code unavailable; the QR code will open registration',
    inviteLinkTitle: 'QR code link',
    partnerInviteHint: 'Your default affiliate link is selected; active channels remain available',
    defaultPartnerLink: 'Default affiliate link',
    sharing: 'Sharing…',
    ...
    pressPrinterButton: 'Press the red button to print',
    printing: 'Printing receipt…',
    detaching: 'Cutting the paper…',
    previewReady: 'Receipt ready',
    beijingTime: 'Times shown in Beijing time',
    ...
    sharePayloadTitle: 'My LaoshirenAI receipt',
    sharePayloadText: 'Here is my AI receipt. Scan it to join me on LaoshirenAI.',
    shared: 'Receipt shared',
    shareFallback: 'Direct sharing is unavailable, so the image was saved instead',
    shareFailed: 'Could not share the receipt',
  ...
  nativeCheckout: {
    ...
    loadingQR: 'Loading payment QR…',
    wechatScanInstruction: 'Open WeChat and scan the QR code above to complete payment.',
    alipayScanInstruction: 'Open Alipay and scan the QR code above to complete payment.',
    scanInstruction: 'Scan the QR code above with the corresponding payment app.',
    linkQRHint: 'This QR opens the payment page. The card shop may ask for one verification step.',
    orderProgress: 'Order progress',
    orderCheckingTitle: 'Checking your order',
    orderCreatedAt: 'Created (Beijing time): {time}',
    recommendedWindow: 'Recommended payment window: {time}',
    recommendedWindowExpired: 'The recommended window has passed. If you paid, keep waiting and do not pay again.',
    automaticEta: 'Your balance usually arrives within 3–15 seconds after payment.',
    emailCheck: 'If automatic verification does not finish, open the registered email below and use the link in the order email to continue:',
    creatingOrder: 'Creating your order…',
    creditingHint: 'Payment confirmed. Applying your credit…',
    paymentCompleted: 'Payment complete and credit applied',
    waitingPayment: 'Waiting for payment. Credit is applied automatically.',
  ...
  topup: {
    ...
    customAmountPlaceholder: 'Enter amount (min ¥20)',
    selectPayType: 'Payment Method',
    alipay: 'Alipay',
    wechat: 'WeChat Pay',
    noAvailablePayType: 'No payment method is available. Please contact the administrator.',
    confirmButton: 'Proceed to Pay',
    ...
    minAmountError: 'Minimum top-up amount is ¥20',
    maxAmountError: 'Maximum top-up amount is ¥3000',
    invalidAmount: 'Please enter a valid amount',
    notConfigured: 'Payment channel not configured, please contact admin.',
    cnyAmount: '¥{amount} CNY',
    creditsNote: '¥1 CNY = ⚡1 platform credit',
    chooseChannel: 'Choose top-up method',
    alipayScanTitle: 'Alipay QR',
    alipayScanDesc: 'Scan with Alipay and receive balance automatically.',
    wechatScanTitle: 'WeChat QR',
    wechatScanDesc: 'Scan with WeChat Pay and receive balance automatically.',
    qrChannelTitle: 'QR Payment',
    qrChannelDesc: 'Scan with Alipay or WeChat. Balance is credited automatically.',
    cardShopChannelTitle: 'Backup payment method',
    cardShopChannelDesc: 'Use the backup option when QR payment is unavailable.',
    availableNow: 'Available now',
    comingSoon: 'Not available yet',
    balanceCardsTitle: 'Choose a balance card',
    promotionalCardsTitle: 'Promotional top-up cards',
    promotionalCardTitle: 'Pay ¥{paid}',
    ...
    monthlyPlanStatus: 'Supplying',
    monthlyPlanPrice: 'Monthly price',
    monthlyPlanDirectPrice: 'QR payment price',
    monthlyPlanWeeklyLimit: 'Weekly limit',
    monthlyPlanMonthlyLimit: 'Monthly limit',
    monthlyPlanQuotaMode: 'Quota mode',
    monthlyPlanCreditsValue: '{amount} AI credits / month',
    monthlyPlanSharedPool: 'Use it across GPT, Claude, and Grok monthly services in one shared monthly credit pool',
    ...
    developerMonthlyCard: 'Developer monthly card',
    cardShopAction: 'Backup payment method',
    cardShopUnavailable: 'This product is not available in the card shop. Choose another product or QR payment.',
  ...
  profile: {
    ...
    myInviteCode: 'My Invite Code & Invite Link',
    inviteCodeHint: 'Share this code with friends. They enter it on registration, and both of you can receive the configured first top-up invite bonus.',
    inviteCodeHintWithRates: 'After a friend’s first real purchase, both of you receive 5% of that amount as ⚡ credit immediately. There is no minimum or fixed bonus.',
    ...
    balanceAlert: {
      title: 'Balance Alert',
      enabled: 'Enable Balance Alert',
      enabledHint: 'Get notified by email when your balance drops below the threshold',
      threshold: 'Alert Threshold',
      thresholdHint: 'Leave empty to use the system default',
      default: 'Default',
      email: 'Alert Email',
      emailHint: 'Leave empty to use your login email',
      emailPlaceholder: 'Use login email',
      saveSuccess: 'Balance alert settings saved',
      saveFailed: 'Failed to save settings'
    },
    identity: {
      title: 'Linked Identities',
      description: 'Manage third-party sign-in identities and review their latest activity.',
      connected: 'Connected',
      notConnected: 'Not connected',
      connect: 'Connect',
      connecting: 'Redirecting...',
      disconnect: 'Disconnect',
      disconnectSuccess: 'Identity disconnected',
      disconnectFailed: 'Failed to disconnect identity',
      disconnectConfirmTitle: 'Disconnect Identity',
      disconnectConfirmMessage: 'Are you sure you want to disconnect {provider}?',
	      linuxdoDescription: 'Use your Linux.do account for sign-in and account linking.',
	      googleDescription: 'Use your Google account for sign-in and account linking.',
	      githubDescription: 'Use your GitHub account for sign-in and account linking.',
	      providerDisabled: '{provider} identity binding is currently disabled by the administrator.',
      accountLabel: 'Linked account',
      boundAt: 'Linked at',
      lastLoginAt: 'Last login',
      loadFailed: 'Failed to load linked identities',
      startBindFailed: 'Failed to start identity linking',
      errors: {
        orphanUnbind: 'This is your last available sign-in identity and cannot be disconnected.',
        bindingConflict: 'This identity is already linked to another account.'
      }
    }
  },
  ...
  admin: {
    ...
    rbac: {
      ...
      rolesDesc: 'Manage system roles and their permission assignments',
      ...
      deleteConfirmMsg: 'Are you sure you want to delete role “{name}”? This action cannot be undone.',
      superAdmin: 'Super Admin',
      normalRole: 'Normal Role',
      menus: 'Menu Management',
      menusDesc: 'Manage admin navigation menus',
      createMenu: 'Create Menu',
      noMenus: 'No menus',
      deleteMenuMsg: 'Are you sure you want to delete menu “{name}”?',
      menuNamePlaceholder: 'e.g. User Management',
      englishMenuName: 'English Name',
      englishMenuNamePlaceholder: 'e.g. User Management',
      permKeyPlaceholder: 'e.g. admin:users',
      permKeyLockedHint: 'Permission key is bound to the frontend sidebar and router guard. It cannot be changed after creation; delete and recreate the menu if needed.',
      routePathPlaceholder: 'e.g. /admin/users',
      routePathLockedHint: 'Route paths are registered in frontend code. This field is informational only.',
      component: 'Component',
      apis: 'API Management',
      apisDesc: 'Maintain backend API resources for role assignment',
      createApi: 'New',
      ...
      apiKeywordPlaceholder: 'Search path/description',
      apiGroupPlaceholder: 'e.g. users',
      apiPathPlaceholder: 'e.g. /admin/users/:id',
      apiDescPlaceholder: 'Briefly describe what this endpoint does',
      anyGroup: 'All Groups',
      anyMethod: 'All Methods',
      noApis: 'No APIs',
      deleteApiMsg: 'Are you sure you want to delete {method} {path}?',
      deleteApisMsg: 'Are you sure you want to delete the {count} selected APIs?',
      roleMenu: 'Role Menus',
      roleApi: 'Role APIs',
      filterMenuPlaceholder: 'Filter by menu name/key',
      filterApiPlaceholder: 'Filter by path/description',
      ...
      permissionsDesc: 'Manage system permission menu tree',
    ...
    dashboard: {
      ...
      users: 'Users',
      todayRequests: 'Today Requests',
      userSpendToday: 'Today User Spend',
      yesterdayUserSpend: 'Yesterday',
      totalUserBalance: 'Total User Balance',
      userSpendTodayHint: 'Summed by actual user deduction',
      totalUserBalanceHint: 'Sum of current balances across all non-deleted users',
    ...
    agents: {
      ...
      description: 'Manage partner commissions, invited users, rate settings, and settlements',
      search: 'Search Partners',
      searchPlaceholder: 'Search by email, username, or invite code',
      sortBy: 'Sort By',
      sortOrder: 'Order',
      desc: 'Desc',
      asc: 'Asc',
      ...
      paymentProfile: 'Payment Info',
      paymentProfileStatus: 'Payment Info Status',
      paymentProfileComplete: 'Complete',
      paymentProfileIncomplete: 'Incomplete',
      selected: 'Selected',
      currentViewing: 'Viewing: {agent}',
      invitedUsers: 'Invited Users',
      commissionRecords: 'Commission Records',
      settlementRecords: 'Settlements',
      invitedUserCount: 'Invites',
      totalConsumption: 'Total Consumption',
      totalCommission: 'Total Commission',
      periodCommission: 'Period Commission',
      settledCommission: 'Settled',
      unsettledCommission: 'Unsettled',
      settlementFilter: 'Settlement Filter',
      settlementAll: 'All',
      settlementEligible: 'Ready',
      settlementBelowThreshold: 'Below Minimum',
      settlementMissingProfile: 'Missing Payment Info',
      settlementStatus: 'Settlement Status',
      settlementGap: 'Settlement Gap',
      settlementGapLabel: '{amount} remaining',
      settlementMinimum: 'Minimum Settlement',
      settlementMinimumHint: 'Manual settlement is allowed after cash commission reaches ¥50. You can adjust the threshold here.',
      eligibleSettlementCount: 'Ready Partners',
      settlementSettingsUpdated: 'Settlement threshold updated',
      alipayRealName: 'Alipay Name',
      alipayAccount: 'Alipay Account',
      contactPhone: 'Contact Phone',
      alipayQRCode: 'Alipay QR Code',
      noAlipayQRCode: 'No QR code',
      paymentReference: 'Payment Reference',
      paymentReferencePlaceholder: 'Alipay transfer ID or note',
      consumptionRate: 'Consumption Rate',
      inviteeRate: 'Invitee First Top-up',
      referralRate: 'User Referral First Top-up',
      inviteActivity: 'Timed Invite Campaign',
      inviteActivityHint: 'For public beta or limited-time benefits. When enabled, users who register through an invite link during the campaign window receive the registration bonus immediately.',
      inviteActivityEnabled: 'Enable campaign',
      inviteActivityName: 'Campaign Name',
      inviteActivityNamePlaceholder: 'For example: Public Beta Invite Campaign',
      inviteActivityStart: 'Start Time',
      inviteActivityEnd: 'End Time',
      ...
      levelRules: 'Partner Level Rules',
      levelRulesHint: 'Fast policy: monthly and cumulative usage are based on direct users actual_cost',
      monthlyThreshold: 'Monthly Threshold',
      cumulativeThreshold: 'Cumulative Threshold',
      enabled: 'Enabled',
      lastMonthConsumption: 'Last Month Usage',
      nextLevelGap: 'Next Gap',
      runLevelEvaluation: 'Run All Evaluation',
      runThisAgentLevelEvaluation: 'Run This Partner',
      level_light: 'Light Partner',
      level_standard: 'Standard Partner',
      level_core: 'Core Partner',
      level_super: 'Super Partner',
      level_manual_base: 'Manual Base',
      override: 'Override',
      agentOverride: 'Partner Override',
      bindUser: 'Bind User',
      userEmail: 'User Email',
      userEmailPlaceholder: 'Enter the user email to bind',
      overwriteAgentBinding: 'Overwrite current ownership if the user belongs to another partner',
      settle: 'Settle Balance',
      completeSettlement: 'Complete Settlement',
      settlementAmount: 'Settlement Amount',
      availableToSettle: 'Available to settle {amount}',
      operator: 'Operator',
      note: 'Note',
      noSettlements: 'No settlements yet',
      empty: 'No partners found',
      detailSummary: 'Unsettled {unsettled}, settled {settled}',
      userContribution: 'Contribution',
      totalRecharged: 'Total Recharged',
      ratesUpdated: 'Global rates updated',
      levelRulesUpdated: 'Level rules updated',
      levelEvaluationCompleted: 'Evaluation completed: {count} succeeded, {failed} failed',
      agentLevelEvaluationCompleted: 'Partner evaluation completed',
      agentRateUpdated: 'Agent rate updated',
      userBound: 'Bound user {email}',
      userRebound: 'Rebound user {email}',
      userAlreadyBound: 'User {email} is already under this agent',
      settlementCreated: 'Settlement created',
      failedToLoad: 'Failed to load agent data',
      failedToSave: 'Failed to save agent settings',
      failedToSaveInviteActivity: 'Failed to save timed invite campaign',
      failedToRunLevelEvaluation: 'Failed to run agent level evaluation',
      failedToBindUser: 'Failed to bind user',
      failedToSettle: 'Settlement failed'
    },
    ...
    users: {
      ...
      setAsAgent: 'Set as Partner',
      setAsLightAgent: 'Set as Light Partner (5%)',
      setAsStandardAgent: 'Set as Standard Partner (10%)',
      removeAgent: 'Remove Partner Role',
      setAsAgentSuccess: 'User has been set as partner',
      setAsLightAgentSuccess: 'User has been set as light partner',
      setAsStandardAgentSuccess: 'User has been set as standard partner',
      removeAgentSuccess: 'Partner role removed',
      promoteToAdmin: 'Set as Admin',
      promoteConfirm:
        "Promote user '{email}' to admin? After promotion you still need to bind RBAC roles via \"Assign Roles\" before they can access the admin panel.",
      promoteSuccess: 'User has been promoted to admin',
      demoteAdmin: 'Revoke Admin',
      demoteConfirm:
        "Revoke admin privileges from '{email}'? This will clear all RBAC role bindings and remove access to the admin panel.",
      demoteSuccess: 'Admin privileges revoked',
      assignRoles: 'Assign Roles',
      assignRolesTitle: 'Assign RBAC Roles',
      ...
      // Balance History
      balanceHistory: 'Account History',
      balanceHistoryTip: 'Click to open account history',
      balanceHistoryTitle: 'User Account Change History',
      noBalanceHistory: 'No records found for this user',
      allTypes: 'All Types',
      typeBalance: 'Balance (Redeem)',
      typeTopup: 'Balance (Top-up Order)',
    ...
    groups: {
      ...
      accountsAvailable: '{count} available',
      accountsRateLimited: '{count} rate limited',
      usageToday: 'Today',
      usageTotal: 'Total',
      form: {
        name: 'Name',
    ...
    channels: {
      ...
      description: 'Manage channel group bindings, model mappings, and pricing rules',
      ...
      form: {
        ...
        webSearchEmulationHint: 'Only takes effect when global Web Search emulation is enabled.',
        ...
        models: 'Models',
        modelsPlaceholder: 'Type a model name and press Enter. Wildcard * is supported.',
        modelInputHint: 'Press Enter to add. Pasting supports batch import.',
        noModels: 'No models added',
        billingMode: 'Billing Mode',
        defaultPrices: 'Default Prices (used when no range matches)',
        inputPrice: 'Input',
        outputPrice: 'Output',
        ...
        serviceTierCapability: 'Provider capability verification',
        serviceTierCapabilityHint: 'Forward only after the provider confirms support and a positive multiplier is configured. Off by default.',
        fastSupported: 'Fast / Priority verified',
        flexSupported: 'Flex verified',
        capabilityMultiplierRequired: 'Configure a positive multiplier before enabling Fast/Flex capability',
        ...
        applyPricingToAccountStatsDesc: 'When enabled, account stats amounts are shown using channel pricing rules.',
        accountStatsPricingRules: 'Account Stats Pricing Rules',
        addRule: 'Add Rule',
        noRulesConfigured: 'No rules configured for this platform yet.',
        ruleName: 'Rule name',
        ruleGroups: 'Groups',
        noGroupsInChannel: 'No groups available in this channel yet.',
        ruleAccounts: 'Accounts',
        searchAccountPlaceholder: 'Search account name or ID',
        ruleAccountsHint: 'Optional. Leave empty to apply to all matched accounts on this platform.',
    ...
    subscriptions: {
      ...
      guideTitle: 'Subscription Usage Guide',
      guideIntro: 'Use subscription groups to grant time-limited quota access without charging the user balance for each request.',
      guideCreateGroupTitle: 'Create a subscription group',
      guideCreateGroupBody: 'Create or edit a group, choose subscription billing, and configure its daily, weekly, or monthly quota limits.',
      guideAssignTitle: 'Assign the subscription',
      guideAssignBody: 'Select a user, choose the subscription group, and set the validity period. Only subscription-billed groups appear here.',
      guideOperateTitle: 'Monitor and maintain',
      guideOperateBody: 'Review quota usage and expiration, then adjust validity, reset quota windows, or revoke access when needed.',
      daily: 'Daily',
      weekly: 'Weekly',
      monthly: 'Monthly',
    ...
    accounts: {
      ...
      syncFromCrsDesc:
        'Sync accounts from CRS into this system (CRS is called server-to-server).',
      ...
      gptImageAccount: 'GPT-Image Account',
    ...
    announcements: {
      ...
      form: {
        ...
        status: 'Status',
        notifyMode: 'Notify Mode',
        notifyModeHint: 'Popup mode combines a new batch into one reminder instead of replaying each item',
        startsAt: 'Starts At',
        endsAt: 'Ends At',
    ...
    financeTransactions: {
      ...
      description: 'Record real income and expenses to track revenue, expenses, net profit, and margin',
      ...
      receiptPreviewLoading: 'Loading receipt...',
      receiptPreviewFailed: 'Failed to load the receipt image. Please try again.',
      downloadReceipt: 'Download Receipt',
      enlargeReceipt: 'Click to view full size',
      receiptLightboxTitle: 'Receipt — Full Size',
      closeReceiptLightbox: 'Close full-size receipt',
      openReceiptInNewWindow: 'Open in New Window',
      ...
      categoryLabels: {
        ...
        server_cost: 'Server Expense (Legacy)',
        hosting_cost: 'Fixed Hosting Expense',
        cdn_cost: 'Monthly CDN Expense',
        domain_cost: 'Annual Domain Expense',
        domain_email_cost: 'Monthly Domain Email Expense',
        early_cost: 'One-time Setup Expense',
        other_expense: 'Other Expense'
      },
      paymentChannelLabels: {
        wechat: 'WeChat',
        alipay: 'Alipay',
        liandong_shop: 'Liandong Shop',
      ...
      summary: {
        ...
        monthHint: 'View the selected Asia/Shanghai calendar month',
        expenseStructure: 'Expense Structure',
        expenseStructureHint: 'Separates recurring business, procurement, setup, and other expenses; CDN varies but recurs monthly',
        incomeChannels: 'Income Channels',
        incomeChannelsHint: 'Shows actual collections from WeChat, Alipay, and Liandong Shop',
        transactionsUnit: 'transactions',
        businessGroup: 'Business Layer',
        byCategory: 'Income and Expense Details',
        expenseGroups: {
          fixed_business: 'Fixed Business Expenses',
        ...
        trendTitle: 'Revenue and Expenses — Last 12 Months',
      ...
      form: {
        ...
        paymentChannelHint: 'Required for income; currently WeChat, Alipay, or Liandong Shop',
        amount: 'Amount (CNY)',
    ...
    promo: {
      ...
      bonusAmount: 'Bonus platform credit (⚡)',
      maxUses: 'Max Uses',
    ...
    topupOrders: {
      ...
      description: 'Review top-up order status, payment details, and invoice progress'
    },

    invoiceRequests: {
      title: 'Invoice Request Management',
      description: 'Export invoice requests and process completion or rejection workflows',
      pendingCount: 'Pending Requests',
      searchPlaceholder: 'Search user / serial number',
      export: 'Export Excel',
      exporting: 'Exporting...',
      exportSuccess: 'Export succeeded',
      exportFailed: 'Export failed',
      exportEmpty: 'No invoice requests match the current export filters',
      includeProcessed: 'Include processed records when exporting',
      noRowsToExport: 'No invoice requests match the current export filters',
      noPendingToExport: 'There are no pending invoice requests to export. Enable processed records or adjust the filters.',
      statusAll: 'All request statuses',
      status: {
        pending: 'Pending',
        exported: 'Exported',
        completed: 'Invoiced',
      ...
      completeSuccess: 'Invoice request marked as complete',
      completeFailed: 'Failed to mark invoice request as complete',
      reject: 'Reject',
      rejectSuccess: 'Invoice request rejected',
      rejectFailed: 'Failed to reject invoice request',
      orderDetails: 'Order Details',
      rejectReason: 'Reject Reason',
      rejectDialogTitle: 'Reject Request',
      rejectDialogDescription: 'Rejecting the request will restore the linked orders to an invoice-applicable state.',
      confirmReject: 'Confirm Reject',
      rejecting: 'Submitting...',
      failedToLoad: 'Failed to load invoice requests'
    },
    ...
    ops: {
      ...
      webhook: {
        ...
        feishuHint: 'Supports a Feishu custom bot webhook or a Feishu app bot that sends to a specific chat.',
        ...
        feishuChatId: 'Feishu Chat ID',
        feishuAppBotHint: 'Use these for Feishu app bot delivery. Either webhook or app bot config is enough.',
        ...
        validation: {
          feishuDeliveryRequired: 'Feishu notifications require either a webhook, or Feishu App ID, App Secret, and Chat ID',
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyConfiguredHint: 'Secret key configured. Leave empty to keep the current value.'      },
	      linuxdo: {
	        ...
	        description: 'Configure LinuxDo Connect OAuth for 老实人 AI end-user login',
        ...
        redirectUrlHint:
	      ...
	      google: {
	        title: 'Google Login',
	        description: 'Configure Google OAuth / OpenID Connect for end-user login',
	        enable: 'Enable Google Login',
	        enableHint: 'Show Google login on the login page',
	        providerName: 'Display Name',
	        providerNamePlaceholder: 'Google',
	        clientId: 'Client ID',
	        ...
	        redirectUrlPlaceholder: 'https://your-domain.com/api/v1/auth/oauth/google/callback',
	        redirectUrlHint: 'Must be configured in the Google OAuth client and match exactly.',
	        quickSetCopy: 'Generate & Copy (current site)',
	        redirectUrlSetAndCopied: 'Google redirect URL generated and copied to clipboard'
	      },
	      github: {
	        title: 'GitHub Login',
	        description: 'Configure GitHub OAuth for end-user login',
	        enable: 'Enable GitHub Login',
	        enableHint: 'Show GitHub login on the login page',
	        clientId: 'Client ID',
	        ...
	        redirectUrlHint: 'Must be configured in the GitHub OAuth App. Default scope is read:user user:email.',
	        quickSetCopy: 'Generate & Copy (current site)',
	        redirectUrlSetAndCopied: 'GitHub callback URL generated and copied to clipboard'
	      },
	      defaults: {
      ...
      balanceAlert: {
        title: 'Balance Alert',
        description: 'Automatically notify users by email when their balance drops below threshold',
        enabled: 'Enable Balance Alert',
        enabledHint: 'When enabled, alerts use the user override or the system default threshold',
        defaultThreshold: 'Default Threshold',
        defaultThresholdHint: 'Used when a user does not set a custom threshold, in USD'
      },
      claudeCode: {
      ...
      site: {
        ...
        techSupportQRCode: 'Tech Support QR Code',
        techSupportQRCodePlaceholder: 'https://example.com/tech-qrcode.png',
        techSupportQRCodeHint: 'Image URL of the tech support QR code (handles installation & environment setup).',
        afterSalesQRCode: 'After-Sales QR Code',
        afterSalesQRCodePlaceholder: 'https://example.com/after-sales-qrcode.png',
        afterSalesQRCodeHint: 'Image URL of the after-sales QR code (handles recharge, promotions, etc.).',
      ...
      stripe: {
        ...
        description: 'Configure Stripe Checkout for user balance top-up',
        enabled: 'Enable Stripe Payment',
        enabledHint: 'Allow users to top up their balance via Stripe Checkout',
        secretKey: 'Secret Key',
        secretKeyHint: 'Enter your Stripe secret key (starts with sk_live_ or sk_test_)',
        secretKeyConfiguredHint: 'Secret key is configured. Leave blank to keep the current key.',
        webhookSecret: 'Webhook Secret',
        webhookSecretHint: 'Enter your Stripe webhook signing secret (starts with whsec_)',
        webhookSecretConfiguredHint: 'Webhook secret is configured. Leave blank to keep the current secret.'
      },
      customMenu: {
  ...
  purchase: {
    ...
    stripe: {
      ...
      status: 'Status',
      time: 'Time',
      paymentSuccess: 'Payment successful! Your balance has been updated.',
      statusLabel: {
        pending: 'Pending',
        completed: 'Completed',
        expired: 'Expired',
  ...
  subscriptionAccess: {
    title: 'Top Up Now',
    description: 'Choose an amount and pay with Alipay or WeChat Pay',
    badge: 'TOP UP NOW',
    heading: 'Top Up Now',
    summary: 'Choose your amount and payment method. Your balance will be credited automatically after payment.',
  ...
  topupOrdersPage: {
    ...
    description: 'View top-up orders, payment status, and invoice progress'
  },

  invoicePage: {
    title: 'Invoice Management',
    description: 'Manage invoice profiles and track invoice request progress'
  },
  ...
  announcements: {
    ...
    popupNotice: 'New announcement',
    batchHint: 'This batch is shown once and will not replay one announcement at a time',
    moreInCenter: '{count} more announcements are available in the announcement center',
    viewLater: 'View later',
    viewAllWithCount: 'View all {count} announcements',
    acknowledge: 'Got it',
  ...
  feedback: {
    ...
    empty: {
      ...
      description: 'Use this space to report issues, request features, or leave complaints.',
    },
    columns: {
      category: 'Category',
      title: 'Feedback',
    ...
    form: {
      ...
      description: 'Tell us what happened. We will follow up through your registered email.',
      category: 'Category',
      titleLabel: 'Title',
      content: 'Content',
	  ...
	  requestId: 'Request ID / error details (optional)',
	  requestIdPlaceholder: 'Paste the Request ID or error details here, if available',
	  requestIdHint: 'Leave this blank if you do not have one.',
      images: 'Images',
      imageHint: 'Up to 5 images, each under 5MB. Supports jpg/png/gif/webp.',
      addImage: 'Add image',
      uploading: 'Uploading...',
      imageCount: '{count}/{max}',
      editorFallback: 'The rich editor failed to load, so plain text input is being used.',
    },
    detail: {
    ...
    edit: {
      title: 'Edit Feedback',
      description: 'Update the feedback, error details, or attachments. Feedback already in review cannot be edited.',
      button: 'Edit',
      save: 'Save Changes',
      closedHint: 'This feedback is closed and cannot be edited.',
    },
    reply: {
      user: 'User Reply',
      admin: 'Admin Reply',
      ...
      submit: 'Send Reply',
      empty: 'Reply content is required',
    },
    admin: {
      title: 'Feedback Management',
      description: 'Filter user feedback by category, status, and priority, then reply quickly.',
      detailTitle: 'Feedback Detail',
      search: 'Search title, content, or user',
      batchUpdate: 'Batch Update Status',
      batchDelete: 'Batch Delete',
      confirmDelete: 'Are you sure you want to delete this feedback? This action cannot be undone.',
      confirmBatchDelete: 'Are you sure you want to delete {count} selected feedback(s)? This action cannot be undone.',
      userInfo: 'User Info',
    ...
    message: {
      ...
      detailFailed: 'Failed to load feedback detail',
      updated: 'Feedback updated successfully',
      updateFailed: 'Failed to update feedback',
      replyCreated: 'Reply sent successfully',
      replyFailed: 'Failed to send reply',
      pasteImageBlocked: 'Pasting screenshots into the editor is disabled. Use the image uploader below instead.',
      batchUpdated: 'Batch status update completed',
      batchUpdateFailed: 'Failed to batch update status',
      deleted: 'Feedback deleted successfully',
      deleteFailed: 'Failed to delete feedback',
      batchDeleted: 'Batch delete completed, {count} item(s) deleted',
      batchDeleteFailed: 'Failed to batch delete feedback',
      rateLimited: 'You are submitting feedback too frequently. Please try again later.',
      rateLimitedWithRetry: 'You are submitting feedback too frequently. Try again in {seconds} seconds.',
    },
  },
