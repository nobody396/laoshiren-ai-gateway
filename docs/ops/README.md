...
- `CHANGELOG.md`: how to write and publish curated Build in Public updates, including the boundary with announcements and Git history.
- `monitoring.md`: the boundary between the in-process monthly upstream probe and the independent external public readiness monitor.
