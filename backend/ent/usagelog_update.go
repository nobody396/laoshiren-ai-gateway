...
func (_u *UsageLogUpdate) AddActorUserID(v int64) *UsageLogUpdate {
...
func (_u *UsageLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ActorUserID(); ok {
		_spec.SetField(usagelog.FieldActorUserID, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.AddedActorUserID(); ok {
		_spec.AddField(usagelog.FieldActorUserID, field.TypeInt64, value)
	}
	if _u.mutation.ActorUserIDCleared() {
		_spec.ClearField(usagelog.FieldActorUserID, field.TypeInt64)
	}
...
// AddActorUserID adds value to the "actor_user_id" field.
func (_u *UsageLogUpdateOne) AddActorUserID(v int64) *UsageLogUpdateOne {
	_u.mutation.AddActorUserID(v)
	return _u
}
