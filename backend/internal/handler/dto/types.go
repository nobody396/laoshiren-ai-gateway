...
type User struct {
	...
	FirstRecharged bool   `json:"first_recharged"`
...
type AdminGroup struct {
	Group
	UniversalRoutes []domain.UniversalRouteConfig `json:"universal_routes"`
...
type AdminUsageLog struct {
	...
	// AccountStatsCost 账号成本基础值（乘 account_rate_multiplier 前）
