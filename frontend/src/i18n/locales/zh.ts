export default {
  ...
  home: {
    ...
    // Hero 区块
    heroTitle1: '企业级',
    heroTitle2: '一站式AI Gateway',
    heroDescription: '无需编程基础，仅依靠自然语言，就能将您的想法变为现实！用最简单的配置即刻使用稳定、安全、优惠的',
    heroDescriptionEnd: '，体验当前全球最顶级的AI编程工具。为企业和开发者',
    heroEfficiency: '提效300%',
    heroCta: '免费使用',
    heroCtaSecondary: '加入AI社群',
    heroBadge: '领取免费额度',
    heroStats: {
      users: '10000+',
      usersLabel: '订阅用户',
      companies: '200+',
      companiesLabel: '知名企业/高校选择',
      days: '280天+',
      daysLabel: '稳定提供服务'
    },
    tags: {
    ...
    pricing: {
      ...
      title: '适合不同阶段开发者的',
      titleHighlight: '套餐定价',
      subtitle: '我们为常驻开发者准备了更实惠的订阅套餐。',
      disclaimer: '* 上述套餐为示意性展示，实际价格与权益请以控制台「订阅」页面与官方公告为准。',
      ctaButton: '立即订阅',
      plans: {
        paygo: {
          category: '按量付费',
        ...
        monthly: {
          ...
          badge: '最受欢迎',
          name: '包月付费套餐',
          description: '包月付费，每天固定可用额度，额度不结转。',
          price: '¥198.00',
          priceUnit: '/ 月 起',
          features: [
            '覆盖主流 Claude / Codex 编码模型调用',
  ...
  common: {
    ...
    chooseFile: '选择文件',
    notAvailable: '不可用',
    permissionDenied: '您没有访问该功能的权限，请联系管理员分配权限',
  ...
  auth: {
    ...
    promoCodeValid: '有效！注册后将获得 ⚡${amount} 平台额度',
    ...
    referralCodePlaceholder: '输入邀请码（选填）',
    referralCodeHint: '如果您通过邀请链接或邀请码注册，填入后首次充值双方均可获得奖励',
    linuxdo: {
      ...
      bindingSuccess: 'Linux.do 账号绑定成功',
      bindingConflict: '该 Linux.do 账号已绑定到其他用户',
      bindingFailed: '绑定失败，请稍后重试',
      stateExpired: '此次授权已过期，请重新发起绑定或登录',
      stateConsumed: '此次授权已被使用，请重新发起绑定或登录',
      invalidState: '授权状态无效，请重新发起绑定或登录',
      missingVerifier: '授权校验信息缺失，请重新发起绑定或登录',
      providerError: 'Linux.do 授权返回了错误',
      tokenExchangeFailed: '获取 Linux.do 授权令牌失败',
      userInfoFailed: '获取 Linux.do 用户信息失败',
      loginFailed: 'Linux.do 登录失败，请稍后重试'
	    ...
	    oauth: {
	      ...
	      callbackMissingToken: '登录信息缺失，请返回重试。',
	      backToLogin: '返回登录',
	      invitationRequired: '该 {provider} 账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
	      referralOptional: '该 {provider} 账号尚未注册。如果你有推荐码，可以填写后继续；没有也可以跳过。',
	      invalidPendingToken: '注册凭证已失效，请重新发起第三方登录。',
	      completeRegistration: '完成注册',
	      completing: '正在完成注册...',
	      completeRegistrationFailed: '注册失败，请检查邀请码后重试。',
	      skipReferral: '跳过推荐码',
	      bindingSuccess: '{provider} 账号绑定成功',
	      bindingConflict: '该第三方账号已绑定到其他用户',
	      bindingFailed: '绑定失败，请稍后重试',
	      stateExpired: '此次授权已过期，请重新发起绑定或登录',
	      stateConsumed: '此次授权已被使用，请重新发起绑定或登录',
	      invalidState: '授权状态无效，请重新发起绑定或登录',
	      missingVerifier: '授权校验信息缺失，请重新发起绑定或登录',
	      providerError: '{provider} 授权返回了错误',
	      tokenExchangeFailed: '获取 {provider} 授权令牌失败',
	      userInfoFailed: '获取 {provider} 用户信息失败',
	      loginFailed: '{provider} 登录失败，请稍后重试'
	    },
    oauthCallbackTitle: '授权登录中',
    // 忘记密码
    forgotPassword: '忘记密码？',
  ...
  agent: {
    ...
    dateRange: '日期范围',
    allTime: '全部时间',
    totalCommission: '累计分润',
    settledCommission: '已结算分润',
    unsettledCommission: '未结算分润',
    thisMonthCommission: '本月分润',
    periodCommission: '区间分润',
    currentRate: '当前分润比例',
    agentLevel: '合伙人等级',
    permanentLevel: '永久等级',
    temporaryLevel: '临时等级',
    ...
    upgradeTime: '预计升级',
    upgradeAtAssessment: '将在 {time} 自动评档升级',
    upgradeAfterTargetAtAssessment: '达标后将在 {time} 自动评档升级',
    monthlyProgress: '本月考核进度',
    cumulativeProgress: '累计永久进度',
    targetLevelWithRate: '{level} / {rate}',
    maxLevelReached: '已到最高等级',
    thisMonthPerformance: '本月业绩',
    totalPerformance: '累计业绩',
    ...
    levelManual: '手动基准',
    invitedUsers: '邀请用户',
    invitedUsersDesc: '查看直属用户的付费权益、确认消费与佣金；月卡按权益金额计入，新人体验消费不产生佣金',
    userLabel: '用户',
    ...
    viewCommissionsDesc: '按类型和日期筛选查看详细分润流水',
    joinedAt: '注册时间',
    totalRecharge: '累计付费权益',
    totalConsumption: '累计确认消费',
    noInvitedUsers: '暂无邀请用户',
    commissionRecords: '分润记录',
    commissionType: '类型',
    triggeredBy: '触发用户',
    sourceAmount: '原始金额',
    commissionAmount: '分润金额',
    noCommissions: '暂无分润记录',
    allTypes: '全部类型',
    typeConsumption: 'API 长效分润',
    typeSelfConsumption: '本人消费返佣',
    typeFirstRechargeInvitee: '首笔实付奖励（被邀请人）',
    typeFirstRechargeFriendInvitee: '首笔实付奖励（被邀请人）',
    typeFirstRechargeReferral: '首笔实付奖励（邀请人）',
    type_consumption: 'API 长效分润',
    type_consumption_commission: 'API 长效分润',
    type_self_consumption_commission: '本人消费返佣',
    type_consumption_reversal: '消费冲回',
    type_first_recharge_invitee: '首笔实付奖励（被邀请人）',
    type_first_recharge_invitee_bonus: '首笔实付奖励（被邀请人）',
    type_first_recharge_friend_invitee: '首笔实付奖励（被邀请人）',
    type_first_recharge_friend_invitee_bonus: '首笔实付奖励（被邀请人）',
    type_first_recharge_referral: '首笔实付奖励（邀请人）',
    type_first_recharge_referral_bonus: '首笔实付奖励（邀请人）',
    type_invite_activity_registration_bonus: '限时活动注册赠送',
    selfConsumptionTrigger: '本人消费',
    paymentProfile: '收款信息',
    paymentProfileHint: '用于佣金结算，未结算佣金达到起结门槛后即可结算',
    settlementMinimum: '起结门槛',
    settlementStatus: '结算状态',
    settlementProgress: '起结进度',
    settlementEligible: '可结算',
    settlementBelowMinimum: '未达起结门槛',
    settlementReady: '已达到起结门槛',
    settlementGap: '还差 {amount} 可结算',
    paymentProfileIncomplete: '收款信息未完整',
    alipayRealName: '支付宝姓名',
    alipayRealNamePlaceholder: '与支付宝实名一致',
    alipayAccount: '支付宝账号',
    alipayAccountPlaceholder: '手机号或邮箱',
    contactPhone: '联系电话',
    alipayQRCode: '支付宝收款码',
    paymentNote: '收款备注',
    optional: '选填',
  ...
  user: {
    ...
    referral: {
      ...
      boundAgent: '您已通过合伙人邀请码注册',
      boundUser: '您已通过好友邀请码注册',
      notBound: '您尚未绑定邀请码',
      firstRechargeReceived: '首笔实付奖励已到账',
      firstRechargePending: '完成首笔真实付费即可领取奖励',
      myInviteCode: '我的邀请码及邀请链接',
      inviteHint: '邀请好友注册；好友完成首笔真实付费后，您和好友各得实付金额 5% 的 ⚡。',
      inviteHintWithRates: '邀请好友注册，好友首次充值时您获得充值金额 {referralRate} 的邀请金，好友账户余额增加充值金额的 {inviteeRate}。',
      invitedCount: '已邀请用户',
      totalCommission: '累计邀请金',
      thisMonthCommission: '本月邀请金',
    },
  },
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      gptImage: {
        description: 'GPT-Image 使用独立异步图片接口。请将 Base URL 设为站点的 /gpt-image/v1，提交生成任务后轮询 /tasks/{task_id} 获取最终图片。',
        note: '当前链路固定使用模型 gpt-image-2，仅支持 n=1。size 使用比例（如 1:1、16:9），resolution 支持 1k、2k、4k，并按分组中的对应分辨率价格扣费。',
        endpointHint: 'Base URL：{baseUrl}，提交接口：POST /images/generations；size 为比例，resolution 为 1k / 2k / 4k',
        pollHint: '提交成功后会返回 task_id，将示例中的 task_xxx 替换为实际 task_id；completed 后读取 data.result.images[0].url[0]'
      },
      antigravity: {
    ...
    ccsClientSelect: {
      title: '选择使用工具',
      description: '这个密钥可以导入以下兼容工具，确认后将由 CC Switch 自动写入配置：',
      compatibilityNote: '这里只展示与当前分组协议兼容的工具。Grok Build 使用兼容 CC Switch 3.19.2 的一次性自动配置；OpenClaw 和 Hermes 需要 3.16.5 或更高版本。',
      claudeCodeCli: 'Claude Code CLI',
      claudeCodeCliDesc: '导入为终端版 Claude Code 配置',
      claudeDesktopManualNotice: 'Claude Desktop 不支持 Provider Deep Link。请先在这里导入 Claude Code，再到 CC Switch 的 Claude Desktop 页面点击“从 Claude Code 导入已有 Provider”，检查模型映射后启用。',
      codex: 'Codex',
      codexDesc: '使用 OpenAI Responses 协议',
      codexStandard: 'Codex · 标准 272K',
      codexStandardDesc: '272K 窗口，258K 自动压缩，适合日常任务',
      codexLong: 'Codex · 高上下文 1M',
      codexLongDesc: '1M 窗口，900K 自动压缩；超过 272K 将触发长上下文阶梯计费',
  ...
  usageReceipt: {
    ...
    title: '我的 AI 小票',
    description: '把真实消费、Token 与模型明细打印成一张可以直接分享的老实人AI小票。二维码自动使用你的专属邀请链接。',
    backToUsage: '返回使用记录',
    settingsLabel: '小票设置',
    periodTitle: '选择统计周期',
    periodHint: '小票数据直接来自你的真实使用记录',
    privacyTitle: '决定分享什么',
    ...
    showModels: '显示模型明细',
    showModelsHint: '只显示模型名、请求数、Token 与实付金额',
    safeByDefault: '小票不会包含 API Key、请求内容、IP、邮箱或任何可用于登录的信息。',
    shareTitle: '保存并分享',
    ordinaryInviteReady: '二维码已绑定你的普通邀请链接',
    partnerInviteReady: '二维码已绑定你的合伙人分佣链接',
    inviteFallback: '邀请码暂不可用，二维码将指向注册页',
    inviteLinkTitle: '二维码链接',
    partnerInviteHint: '默认使用合伙人分佣链接，可切换有效渠道',
    defaultPartnerLink: '默认合伙人链接',
    sharing: '正在分享…',
    shareImage: '分享小票',
    exporting: '正在生成…',
    downloadImage: '保存图片',
    printAgain: '再打印一次',
    copyInvite: '复制邀请链接',
    pressPrinterButton: '按下红色按钮开始打印',
    printing: '正在打印小票…',
    detaching: '正在切纸，小票即将落下…',
    previewReady: '小票已打印完成',
    beijingTime: '时间按北京时间展示',
    loading: '正在核对你的真实使用数据…',
    loadFailed: '小票没有打印出来',
    loadFailedHint: '使用数据暂时无法读取。没有生成不完整或估算的小票，请稍后重试。',
    downloaded: '小票图片已保存',
    exportFailed: '小票图片生成失败，请重试',
    sharePayloadTitle: '我的老实人AI小票',
    sharePayloadText: '这是我的 AI 小票，扫码可以一起使用老实人AI。',
    shared: '小票已分享',
    shareFallback: '当前浏览器不支持直接分享，已为你保存图片',
    shareFailed: '小票分享失败，请重试',
  ...
  nativeCheckout: {
    ...
    alipayPay: '支付宝',
    qrPayment: '扫码支付',
    scanToPay: '扫码支付 ¥{amount}',
    wechatQRAlt: '微信支付二维码',
    alipayQRAlt: '支付宝支付二维码',
    paymentQRAlt: '支付二维码',
    loadingQR: '正在获取支付二维码…',
    wechatScanInstruction: '请打开微信，使用“扫一扫”扫描上方二维码完成付款。',
    alipayScanInstruction: '请打开支付宝，使用“扫一扫”扫描上方二维码完成付款。',
    scanInstruction: '请使用对应的支付应用扫描上方二维码完成付款。',
    linkQRHint: '这是支付入口二维码；扫码后可能需要在链动小铺完成一次验证。',
    orderProgress: '订单进度',
    orderCheckingTitle: '订单正在核对中',
    orderCreatedAt: '下单时间（北京时间）：{time}',
    recommendedWindow: '建议在 {time} 内完成支付',
    recommendedWindowExpired: '建议支付时间已过；如已付款请继续等待核对，请勿重复支付。',
    automaticEta: '通常付款后约 3–15 秒到账。',
    emailCheck: '若自动核对未完成，请打开以下注册邮箱，点击订单邮件中的链接继续核对：',
    creatingOrder: '正在创建订单，请稍候…',
    creditingHint: '支付已确认，正在到账…',
    paymentCompleted: '支付成功，已到账',
    waitingPayment: '等待支付，支付完成后将自动到账',
    createFailed: '暂时无法创建体验订单，请稍后重试',
    qrUnavailable: '暂时无法获取支付二维码，请稍后重试',
  ...
  topup: {
    ...
    selectAmount: '选择充值金额',
    customAmount: '自定义金额',
    customAmountPlaceholder: '输入金额（最低 ¥20）',
    selectPayType: '选择支付方式',
    alipay: '支付宝',
    wechat: '微信支付',
    noAvailablePayType: '暂无可用支付方式，请联系管理员',
    confirmButton: '确认充值',
    scanQRCode: '扫码支付',
    scanHint: '请使用{payType}扫描二维码完成支付',
    qrExpiry: '二维码有效期',
    qrExpired: '二维码已过期',
    qrContentHint: '二维码由本站根据支付内容生成，请使用对应支付应用扫码完成支付',
    refresh: '重新获取',
    waitingPayment: '等待支付...',
    paySuccess: '充值成功！余额已更新',
    payFailed: '支付失败，请重试',
    submitting: '正在创建订单...',
    minAmountError: '最低充值金额为 ¥20',
    maxAmountError: '单次充值最高为 ¥3000',
    invalidAmount: '请输入有效金额',
    notConfigured: '当前支付渠道未配置，请联系管理员',
    cnyAmount: '¥{amount} 人民币',
    creditsNote: '充值 ¥1 = 获得 ⚡1 平台额度',
    chooseChannel: '选择充值方式',
    alipayScanTitle: '支付宝扫码',
    alipayScanDesc: '支付宝扫码支付，成功后余额自动到账',
    wechatScanTitle: '微信扫码',
    wechatScanDesc: '微信扫码支付，成功后余额自动到账',
    qrChannelTitle: '扫码支付',
    qrChannelDesc: '支付宝/微信扫码，支付成功后自动到账',
    cardShopChannelTitle: '备用支付方式',
    cardShopChannelDesc: '扫码不可用时，可使用备用方式完成购买与兑换',
    availableNow: '当前可用',
    comingSoon: '暂未开放',
    balanceCardsTitle: '选择余额卡',
    promotionalCardsTitle: '优惠充值卡',
    promotionalCardTitle: '实付 ¥{paid}',
    ...
    monthlyPlanStatus: '正在供应',
    monthlyPlanPrice: '月卡价格',
    monthlyPlanDirectPrice: '扫码支付价',
    monthlyPlanWeeklyLimit: '周限制',
    monthlyPlanMonthlyLimit: '月限制',
    monthlyPlanQuotaMode: '额度规则',
    monthlyPlanCreditsValue: '{amount} AI credits / 月',
    monthlyPlanSharedPool: '可用于 GPT 月卡、Claude 月卡和 Grok 月卡，共用同一份月度额度',
    monthlyPlanModelsPrefix: '具体支持模型请查看',
    monthlyPlanModelsLink: '模型定价',
    monthlyPlanGptRate: 'GPT Pro 换算',
    ...
    productType: '商品类型',
    balanceCard: '余额卡',
    developerMonthlyCard: '开发者月卡',
    cardShopAction: '备用支付方式',
    cardShopUnavailable: '当前商品暂不支持卡密购买，请选择其他商品或扫码支付。',
  ...
  profile: {
    ...
    memberSince: '注册时间',
    myInviteCode: '我的邀请码及邀请链接',
    inviteCodeHint: '分享此邀请码给好友；好友注册并完成首笔真实付费后，您和好友各得实付金额 5% 的 ⚡。',
    inviteCodeHintWithRates: '好友首笔真实付费后，您和好友都实时获得首笔金额 5% 的 ⚡平台额度；不设最低金额，也没有固定奖励。',
    administrator: '管理员',
    user: '用户',
    username: '用户名',
    enterUsername: '输入用户名',
    ...
    balanceNotify: {
      ...
      enabled: '启用余额不足提醒',
      threshold: '自定义阈值',
      thresholdHint: '留空则使用系统默认值',
      thresholdPlaceholder: '输入金额',
      systemDefault: '系统默认',
      extraEmails: '通知邮箱',
      extraEmailsHint: '需要添加并验证邮箱地址后才能接收余额提醒',
      primaryEmail: '主邮箱',
    ...
    balanceAlert: {
      title: '余额预警',
      enabled: '启用余额预警',
      enabledHint: '当余额低于阈值时自动发送邮件通知',
      threshold: '预警阈值',
      thresholdHint: '留空则使用系统默认值',
      default: '默认',
      email: '接收邮箱',
      emailHint: '留空则使用登录邮箱',
      emailPlaceholder: '使用登录邮箱',
      saveSuccess: '余额预警设置已保存',
      saveFailed: '保存失败'
    },
    identity: {
      title: '身份绑定',
      description: '管理第三方登录身份，并查看最近绑定状态。',
      connected: '已绑定',
      notConnected: '未绑定',
      connect: '绑定',
      connecting: '跳转中...',
      disconnect: '解绑',
      disconnectSuccess: '身份已解绑',
      disconnectFailed: '解绑失败，请稍后重试',
      disconnectConfirmTitle: '确认解绑身份',
      disconnectConfirmMessage: '确定要解绑 {provider} 吗？',
	      linuxdoDescription: '用于使用 Linux.do 账号登录或完成后续绑定。',
	      googleDescription: '用于使用 Google 账号登录或完成后续绑定。',
	      githubDescription: '用于使用 GitHub 账号登录或完成后续绑定。',
	      providerDisabled: '管理员尚未启用 {provider} 身份绑定。',
      accountLabel: '绑定账号',
      boundAt: '绑定时间',
      lastLoginAt: '最近登录',
      loadFailed: '加载身份绑定信息失败',
      startBindFailed: '发起绑定失败，请稍后重试',
      errors: {
        orphanUnbind: '当前账号只剩这一个登录身份，无法解绑。',
        bindingConflict: '该身份已绑定到其他账号。'
      }
    }
  },
  ...
  admin: {
    ...
    rbac: {
      ...
      confirmDelete: '确认删除',
      deleteConfirmMsg: '确定要删除角色 “{name}” 吗？此操作不可撤销。',
      superAdmin: '超级管理员',
      normalRole: '普通角色',
      menus: '菜单管理',
      menusDesc: '维护后台导航菜单',
      createMenu: '创建菜单',
      noMenus: '暂无菜单数据',
      deleteMenuMsg: '确定要删除菜单 “{name}” 吗？',
      menuNamePlaceholder: '如: 用户管理',
      englishMenuName: '英文名称',
      englishMenuNamePlaceholder: '如: User Management',
      permKeyPlaceholder: '如: admin:users',
      permKeyLockedHint: '权限标识与前端侧边栏 / 路由守卫绑定，创建后不可修改；如需变更请删除后重建。',
      routePathPlaceholder: '如: /admin/users',
      routePathLockedHint: '路由路径由前端代码注册，仅作记录用；编辑此字段不会改变实际跳转地址。',
      component: '组件路径',
      apis: 'API 管理',
      apisDesc: '维护后台接口资源清单，供角色分配使用',
      createApi: '新增',
      batchDelete: '批量删除',
      syncApis: '同步 API',
      apiGroup: 'API 分组',
      apiMethod: '请求方法',
      apiDescription: 'API 简介',
      apiKeywordPlaceholder: '搜索路径/描述',
      apiGroupPlaceholder: '如: users',
      apiPathPlaceholder: '如: /admin/users/:id',
      apiDescPlaceholder: '简要描述此接口用途',
      anyGroup: '全部分组',
      anyMethod: '全部方法',
      noApis: '暂无 API 数据',
      deleteApiMsg: '确定要删除 {method} {path} 吗？',
      deleteApisMsg: '确定要删除已选中的 {count} 条 API 吗？',
      roleMenu: '角色菜单',
      roleApi: '角色 API',
      filterMenuPlaceholder: '筛选菜单名称/标识',
      filterApiPlaceholder: '筛选路径/描述',
      selectAll: '全选',
      invertSelection: '反选',
      clear: '清空',
      selectGroup: '全选',
    ...
    dashboard: {
      ...
      todayCost: '今日消费',
      totalCost: '总消费',
      userSpendToday: '今日用户消费',
      yesterdayUserSpend: '昨日',
      totalUserBalance: '全站剩余余额',
      userSpendTodayHint: '按用户实际扣费口径统计',
      totalUserBalanceHint: '所有未删除用户当前余额汇总',
      actual: '实际',
      accountCost: '账号计费',
      standard: '标准',
      todayTokens: '今日 Token',
    ...
    agents: {
      title: '合伙人管理',
      description: '管理合伙人分润、邀请用户、比例配置和结算记录',
      search: '搜索合伙人',
      searchPlaceholder: '按邮箱、用户名或邀请码搜索',
      sortBy: '排序字段',
      sortOrder: '排序方向',
      desc: '降序',
      asc: '升序',
      ...
      viewDetails: '查看详情',
      paymentProfile: '收款信息',
      paymentProfileStatus: '收款信息状态',
      paymentProfileComplete: '已完整',
      paymentProfileIncomplete: '未完整',
      selected: '当前查看',
      currentViewing: '当前查看：{agent}',
      invitedUsers: '邀请用户',
      commissionRecords: '分润流水',
      settlementRecords: '结算记录',
      invitedUserCount: '邀请人数',
      totalConsumption: '总消费',
      totalCommission: '总佣金',
      periodCommission: '区间佣金',
      settledCommission: '已结算',
      unsettledCommission: '未结算',
      settlementFilter: '结算筛选',
      settlementAll: '全部',
      settlementEligible: '可结算',
      settlementBelowThreshold: '未达门槛',
      settlementMissingProfile: '未填收款信息',
      settlementStatus: '结算状态',
      settlementGap: '结算差额',
      settlementGapLabel: '还差 {amount}',
      settlementMinimum: '起结门槛',
      settlementMinimumHint: '现金佣金达到 ¥50 后才允许人工结算，可在这里调整门槛。',
      eligibleSettlementCount: '可结算人数',
      settlementSettingsUpdated: '结算门槛已更新',
      alipayRealName: '支付宝姓名',
      alipayAccount: '支付宝账号',
      contactPhone: '联系电话',
      alipayQRCode: '支付宝收款码',
      noAlipayQRCode: '暂无收款码',
      paymentReference: '付款流水号',
      paymentReferencePlaceholder: '可填写支付宝转账单号或备注',
      consumptionRate: '消耗分润比例',
      inviteeRate: '被邀请人首笔实付奖励',
      referralRate: '邀请人首笔实付奖励',
      inviteActivity: '限时邀请活动',
      inviteActivityHint: '用于公测、限时福利等活动；启用后，活动期内通过邀请链接注册的用户立即获得注册赠送额度。',
      inviteActivityEnabled: '启用活动',
      inviteActivityName: '活动名称',
      inviteActivityNamePlaceholder: '例如：公测邀请活动',
      inviteActivityStart: '开始时间',
      inviteActivityEnd: '结束时间',
      ...
      currentLevel: '当前等级',
      levelRules: '合伙人等级规则',
      levelRulesHint: '快速口径：按直属客户 actual_cost 统计月度与累计消耗',
      monthlyThreshold: '月度门槛',
      cumulativeThreshold: '累计门槛',
      enabled: '启用',
      lastMonthConsumption: '上月消耗',
      nextLevelGap: '升级差额',
      runLevelEvaluation: '重跑全部评档',
      runThisAgentLevelEvaluation: '重跑该合伙人评档',
      level_light: '新锐合伙人',
      level_standard: '标准合伙人',
      level_core: '核心合伙人',
      level_super: '超级合伙人',
      level_manual_base: '手动基准',
      override: '单独',
      agentOverride: '启用单独比例',
      bindUser: '绑定用户',
      userEmail: '用户邮箱',
      userEmailPlaceholder: '输入需要绑定的用户邮箱',
      overwriteAgentBinding: '如果用户已属于其他合伙人，则覆盖当前归属',
      settle: '结算余额',
      completeSettlement: '结算完毕',
      settlementAmount: '结算金额',
      availableToSettle: '当前可结算 {amount}',
      operator: '操作人',
      note: '备注',
      noSettlements: '暂无结算记录',
      empty: '暂无合伙人',
      detailSummary: '未结算 {unsettled}，已结算 {settled}',
      userContribution: '贡献佣金',
      totalRecharged: '累计充值',
      ratesUpdated: '全局比例已更新',
      levelRulesUpdated: '等级规则已更新',
      levelEvaluationCompleted: '评档完成：成功 {count}，失败 {failed}',
      agentLevelEvaluationCompleted: '该合伙人评档已完成',
      agentRateUpdated: '合伙人比例已更新',
      userBound: '已绑定用户 {email}',
      userRebound: '已改绑用户 {email}',
      userAlreadyBound: '用户 {email} 已在该合伙人名下',
      settlementCreated: '结算记录已创建',
      failedToLoad: '加载合伙人数据失败',
      failedToSave: '保存合伙人配置失败',
      failedToSaveInviteActivity: '保存限时邀请活动失败',
      failedToRunLevelEvaluation: '执行合伙人评档失败',
      failedToBindUser: '绑定用户失败',
      failedToSettle: '结算失败'
    },
    ...
    users: {
      ...
      setAsAgent: '设为合伙人',
      setAsLightAgent: '设为新锐合伙人 (5%)',
      setAsStandardAgent: '设为标准合伙人 (10%)',
      removeAgent: '撤销合伙人',
      setAsAgentSuccess: '已将用户设为合伙人',
      setAsLightAgentSuccess: '已将用户设为新锐合伙人',
      setAsStandardAgentSuccess: '已将用户设为标准合伙人',
      removeAgentSuccess: '已撤销合伙人角色',
      promoteToAdmin: '设为后台管理员',
      promoteConfirm: "确认将用户 '{email}' 升级为后台管理员？升级后需在「分配角色」里绑定具体 RBAC 角色才能访问后台。",
      promoteSuccess: '已将用户设为后台管理员',
      demoteAdmin: '取消后台管理员',
      demoteConfirm: "确认取消 '{email}' 的后台管理员身份？此操作将清空该用户所有 RBAC 角色绑定，且不再能访问后台。",
      demoteSuccess: '已取消后台管理员身份',
      assignRoles: '分配角色',
      assignRolesTitle: '分配 RBAC 角色',
      selectRoles: '选择要分配的角色',
      rolesAssignedSuccess: '角色分配成功',
      failedToAssignRoles: '角色分配失败',
      ...
      replaceGroupHint: '选择新的分组来替换“{old}”。密钥会迁移，权限会自动更新。',
      replaceGroupConfirm: '确认替换',
      replaceGroupSuccess: '分组替换成功，已迁移 {count} 个密钥',
      noOtherGroups: '暂无其他可替换的专属分组',
      // 用户分组配置
      groupConfig: '用户分组配置',
      ...
      // 余额变动记录
      balanceHistory: '账户记录',
      balanceHistoryTip: '点击查看账户变动记录',
      balanceHistoryTitle: '用户账户变动记录',
    ...
    groups: {
      ...
      accountsAvailable: '{count} 个可用',
      accountsRateLimited: '{count} 个限速',
      usageToday: '今日用量',
      usageTotal: '总用量',
      ...
      subscription: {
        title: '订阅设置',
        type: '计费类型',
        typeHint: '标准计费从用户余额扣除。订阅模式使用配额限制；Credits 模式使用折算后额度。',
    ...
    channels: {
      title: '渠道管理',
      description: '管理渠道分组绑定、模型映射与定价规则',
      searchChannels: '搜索渠道...',
      createChannel: '创建渠道',
      editChannel: '编辑渠道',
      deleteChannel: '删除渠道',
      ...
      modelConflict: '模型模式“{model1}”与“{model2}”冲突：匹配范围重叠',
      mappingConflict: '模型映射源“{model1}”与“{model2}”冲突：匹配范围重叠',
      ...
      form: {
        ...
        status: '状态',
        restrictModels: '限制模型',
        restrictModelsHint: '启用后，仅允许定价列表中的模型，其他模型会被拒绝。',
        ...
        webSearchEmulationHint: '仅在已全局启用 Web Search 模拟时可生效。',
        modelMapping: '模型映射',
        ...
        serviceTierCapability: '供应商能力确认',
        serviceTierCapabilityHint: '只有供应商明确确认支持、并已配置正倍率后才允许转发；默认关闭。',
        fastSupported: '已确认 Fast / Priority',
        flexSupported: '已确认 Flex',
        capabilityMultiplierRequired: '启用 Fast/Flex 能力前必须配置对应的正倍率',
        ...
        applyPricingToAccountStats: '将定价应用到账号统计',
        applyPricingToAccountStatsDesc: '启用后，账号统计会按渠道定价规则计算展示金额。',
        accountStatsPricingRules: '账号统计定价规则',
        addRule: '添加规则',
        noRulesConfigured: '当前平台尚未配置规则。',
        ruleName: '规则名称',
        ruleGroups: '生效分组',
        noGroupsInChannel: '当前渠道下暂无可选分组。',
        ruleAccounts: '指定账号',
        searchAccountPlaceholder: '搜索账号名称或 ID',
        ruleAccountsHint: '可选。留空表示对该平台下命中的账号统一生效。',
    ...
    subscriptions: {
      ...
      usageGuide: '使用指南',
      guideTitle: '订阅使用指南',
      guideIntro: '通过订阅分组为用户提供有期限的配额访问，请求不会逐次扣减用户余额。',
      guideCreateGroupTitle: '创建订阅分组',
      guideCreateGroupBody: '新建或编辑分组，选择订阅计费，并配置每日、每周或每月配额。',
      guideAssignTitle: '分配订阅',
      guideAssignBody: '选择用户和订阅分组并设置有效期；此处只会显示订阅计费分组。',
      guideOperateTitle: '监控与维护',
      guideOperateBody: '查看配额和到期时间，并按需调整有效期、重置配额窗口或撤销访问。',
      daily: '每日',
      weekly: '每周',
      monthly: '每月',
      noLimits: '未配置限额',
    ...
    announcements: {
      ...
      form: {
        ...
        status: '状态',
        notifyMode: '通知方式',
        notifyModeHint: '弹窗模式会把同一批新公告合并成一次提醒，不会逐条连续弹出',
        startsAt: '开始时间',
        endsAt: '结束时间',
    ...
    financeTransactions: {
      ...
      receiptPreviewLoading: '正在加载凭证...',
      receiptPreviewFailed: '凭证图片加载失败，请稍后重试',
      downloadReceipt: '下载凭证',
      enlargeReceipt: '点击查看大图',
      receiptLightboxTitle: '凭证大图',
      closeReceiptLightbox: '关闭凭证大图',
      openReceiptInNewWindow: '在新窗口打开',
    ...
    topupOrders: {
      title: '订单管理',
      description: '查看充值订单状态、支付信息与开票进度'
    },

    invoiceRequests: {
      title: '开票管理',
      description: '导出开票申请并处理完成、驳回等流转状态',
      pendingCount: '待处理申请',
      searchPlaceholder: '搜索用户/流水号',
      export: '导出 Excel',
      exporting: '导出中...',
      exportSuccess: '导出成功',
      exportFailed: '导出失败',
      exportEmpty: '当前筛选条件下没有可导出的开票申请',
      includeProcessed: '导出时包含已处理记录',
      noRowsToExport: '当前筛选条件下没有可导出的开票申请',
      noPendingToExport: '暂无待导出的开票申请，请勾选“导出时包含已处理记录”或调整筛选条件',
      statusAll: '全部申请状态',
      status: {
        pending: '待开票',
        exported: '已导出',
      ...
      orderDetails: '订单明细',
      rejectReason: '驳回原因',
      rejectDialogTitle: '驳回申请',
      rejectDialogDescription: '驳回后关联订单会恢复为可申请状态。',
      confirmReject: '确认驳回',
      rejecting: '提交中...',
      failedToLoad: '加载开票申请失败'
    },
    ...
    ops: {
      ...
      webhook: {
        ...
        feishuTitle: '飞书告警群',
        feishuHint: '支持飞书自定义机器人 Webhook，也支持飞书应用机器人发送到指定群。',
        ...
        feishuChatId: '飞书群 Chat ID',
        feishuAppBotHint: '使用飞书应用机器人时填写，和 Webhook 二选一即可。',
        ...
        validation: {
          feishuDeliveryRequired: '开启飞书通知时必须配置 Webhook，或填写飞书应用 App ID、App Secret 和群 Chat ID',
    ...
    settings: {
      ...
      turnstile: {
        ...
        secretKeyConfiguredHint: '密钥已配置，留空以保留当前值。'
	      ...
	      linuxdo: {
	        ...
	        description: '配置 LinuxDo Connect OAuth，用于 老实人 AI 用户登录',
        ...
        redirectUrlHint: '需与 Connect.Linux.Do 中配置的回调地址一致（必须是 http(s) 完整 URL）',
	      ...
	      google: {
	        title: 'Google 登录',
	        description: '配置 Google OAuth / OpenID Connect，用于用户登录',
	        enable: '启用 Google 登录',
	        enableHint: '在登录页显示 Google 登录入口',
	        providerName: '显示名称',
	        ...
	        clientSecretConfiguredPlaceholder: '********',
	        clientSecretConfiguredHint: '密钥已配置，留空以保留当前值。',
	        redirectUrl: '回调地址（Redirect URI）',
	        redirectUrlPlaceholder: 'https://your-domain.com/api/v1/auth/oauth/google/callback',
	        redirectUrlHint: '需在 Google OAuth Client 中配置，且必须完全一致。',
	        quickSetCopy: '使用当前站点生成并复制',
	        redirectUrlSetAndCopied: '已使用当前站点生成 Google 回调地址并复制到剪贴板'
	      },
	      github: {
	        title: 'GitHub 登录',
	        description: '配置 GitHub OAuth，用于用户登录',
	        enable: '启用 GitHub 登录',
	        enableHint: '在登录页显示 GitHub 登录入口',
	        clientId: 'Client ID',
	        ...
	        clientSecretConfiguredPlaceholder: '********',
	        clientSecretConfiguredHint: '密钥已配置，留空以保留当前值。',
	        redirectUrl: '回调地址（Callback URL）',
	        redirectUrlPlaceholder: 'https://your-domain.com/api/v1/auth/oauth/github/callback',
	        redirectUrlHint: '需在 GitHub OAuth App 中配置，scope 默认使用 read:user user:email。',
	        quickSetCopy: '使用当前站点生成并复制',
	        redirectUrlSetAndCopied: '已使用当前站点生成 GitHub 回调地址并复制到剪贴板'
	      },
	      defaults: {
        title: '用户默认设置',
        description: '新用户的默认值',
      ...
      balanceAlert: {
        title: '余额预警',
        description: '当用户余额低于阈值时自动发送邮件通知',
        enabled: '启用余额预警',
        enabledHint: '开启后将按用户设置和系统默认阈值触发邮件提醒',
        defaultThreshold: '默认阈值',
        defaultThresholdHint: '用户未设置自定义阈值时使用，单位为 USD'
      },
      claudeCode: {
      ...
      site: {
        ...
        techSupportQRCode: '技术客服二维码',
        techSupportQRCodePlaceholder: 'https://example.com/tech-qrcode.png',
        techSupportQRCodeHint: '技术客服二维码图片 URL，负责安装及环境配置问题',
        afterSalesQRCode: '售后客服二维码',
        afterSalesQRCodePlaceholder: 'https://example.com/after-sales-qrcode.png',
        afterSalesQRCodeHint: '售后客服二维码图片 URL，负责账户充值、推广等售后事宜',
        docUrl: '文档链接',
      ...
      stripe: {
        title: 'Stripe 支付',
        description: '配置 Stripe Checkout，允许用户在线充值余额',
        enabled: '启用 Stripe 支付',
        enabledHint: '允许用户通过 Stripe Checkout 充值余额',
        secretKey: 'Secret Key（密钥）',
        secretKeyHint: '输入 Stripe Secret Key（以 sk_live_ 或 sk_test_ 开头）',
        secretKeyConfiguredHint: 'Secret Key 已配置。留空则保持当前密钥不变。',
        webhookSecret: 'Webhook Secret（签名密钥）',
        webhookSecretHint: '输入 Stripe Webhook 签名密钥（以 whsec_ 开头）',
        webhookSecretConfiguredHint: 'Webhook Secret 已配置。留空则保持当前密钥不变。'
      },
      customMenu: {
        title: '自定义菜单页面',
    ...
    tlsFingerprintProfiles: {
      ...
      form: {
        ...
        pasteYamlPlaceholder: '在这里粘贴 TLS Fingerprint Collector 输出的 YAML...',
        pasteYamlHint: '粘贴从 TLS Fingerprint Collector 复制的 YAML，可自动填充所有字段。',
        openCollector: '打开采集器',
        parseYaml: '解析 YAML',
        ...
        cipherSuitesHint: '用逗号分隔的十六进制值，例如 0x1301, 0x1302, 0xc02c',
        curves: '椭圆曲线',
        curvesHint: '用逗号分隔的曲线 ID',
        pointFormats: 'Point Formats',
        signatureAlgorithms: '签名算法',
        alpnProtocols: 'ALPN 协议',
        alpnProtocolsHint: '用逗号分隔，例如 h2, http/1.1',
      ...
      deleteConfirm: '删除模板',
      deleteConfirmMessage: '确定要删除模板 “{name}” 吗？使用该模板的账号将回退到内置默认模板。',
  ...
  subscriptionAccess: {
    title: '现在充值',
    description: '选择充值金额并使用支付宝或微信完成支付',
    badge: 'TOP UP NOW',
    heading: '现在充值',
    summary: '选择充值金额和支付方式，支付完成后余额会自动到账。',
    rateLabel: '充值汇率',
    editAmount: '重新选择金额'
  },
  ...
  topupOrdersPage: {
    title: '我的订单',
    description: '查看充值订单、支付状态和开票进度'
  },

  invoicePage: {
    title: '发票管理',
    description: '管理发票抬头并查看开票申请处理进度'
  },
  ...
  announcements: {
    ...
    viewAll: '查看全部公告',
    popupNotice: '新公告提醒',
    batchHint: '本次只提醒一次，不会逐条连续弹出',
    moreInCenter: '另外还有 {count} 条公告，请前往公告中心查看',
    viewLater: '稍后查看',
    viewAllWithCount: '查看全部 {count} 条公告',
    acknowledge: '我知道了',
    markedAsRead: '已标记为已读',
  ...
  feedback: {
    ...
    empty: {
      title: '还没有反馈记录',
      description: '遇到问题、功能建议或投诉都可以在这里提交。',
    },
    columns: {
      category: '分类',
      title: '反馈内容',
    ...
    form: {
      submit: '提交反馈',
      description: '说清遇到的问题即可；我们会使用你的注册邮箱跟进。',
      category: '反馈分类',
      titleLabel: '反馈标题',
      content: '反馈内容',
	  ...
	  requestId: 'Request ID / 报错信息（选填）',
	  requestIdPlaceholder: '如果有 Request ID 或报错信息，请直接粘贴到这里',
	  requestIdHint: '没有可以留空。',
      images: '图片附件',
      imageHint: '最多 5 张，每张不超过 5MB，支持 jpg/png/gif/webp。',
      addImage: '添加图片',
      uploading: '上传中...',
      imageCount: '{count}/{max}',
      editorFallback: '富文本编辑器加载失败，已自动切换为纯文本输入。',
    },
    detail: {
      title: '反馈详情',
	  ticketTitle: '反馈 #{id}',
    ...
    edit: {
      title: '编辑反馈',
      description: '修改反馈内容、报错信息或图片附件。已进入处理流程的反馈不可编辑。',
      button: '编辑',
      save: '保存修改',
      closedHint: '该反馈已关闭，无法编辑。',
    },
    reply: {
      user: '用户回复',
      admin: '管理员回复',
    ...
    admin: {
      title: '反馈管理',
      description: '按分类、状态和优先级筛选用户反馈并及时回复。',
      detailTitle: '反馈详情',
      search: '搜索标题、内容、用户',
      batchUpdate: '批量更新状态',
      batchDelete: '批量删除',
      confirmDelete: '确定要删除这条反馈吗？删除后不可恢复。',
      confirmBatchDelete: '确定要删除选中的 {count} 条反馈吗？删除后不可恢复。',
      userInfo: '用户信息',
      manage: '处理设置',
      replyTitle: '管理员回复',
	  workflow: '处理进度',
    ...
    message: {
      ...
      replyCreated: '回复发送成功',
      replyFailed: '回复发送失败',
      pasteImageBlocked: '编辑器内不支持直接粘贴截图，请使用下方图片上传。',
      batchUpdated: '批量状态更新成功',
      batchUpdateFailed: '批量状态更新失败',
      deleted: '反馈删除成功',
      deleteFailed: '反馈删除失败',
      batchDeleted: '批量删除成功，已删除 {count} 条',
      batchDeleteFailed: '批量删除失败',
      rateLimited: '提交过于频繁，请稍后再试。',
      rateLimitedWithRetry: '提交过于频繁，请 {seconds} 秒后再试。',
    },
  },
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 老实人 AI 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
