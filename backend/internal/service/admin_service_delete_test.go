...
func (s *userRepoStub) TouchLastActive(context.Context, int64, time.Time) error {
	return nil
}
...
func (s *userRepoStub) RemoveGroupFromUserAllowedGroups(context.Context, int64, int64) error {
...
func (s *userRepoStub) SetInviteCode(context.Context, int64, string) error {
...
func (s *userRepoStub) AdminBindUserToAgent(context.Context, int64, int64, bool) error {
	panic("unexpected AdminBindUserToAgent call")
}

func (s *userRepoStub) SetFirstRecharged(context.Context, int64) (int, error) {
	panic("unexpected SetFirstRecharged call")
}

func (s *userRepoStub) MarkFirstInvitedTopup(context.Context, int64, int64) (int, error) {
	panic("unexpected MarkFirstInvitedTopup call")
}

func (s *userRepoStub) GetInviteCodeByUserID(context.Context, int64) (*string, error) {
	panic("unexpected GetInviteCodeByUserID call")
}

func (s *userRepoStub) CountInvitedByInviterID(context.Context, int64) (int64, error) {
