...
const HOME_DESCRIPTION = '老实人AI 提供面向开发者的 AI 编码网关服务，支持 Claude Code、Codex、ChatGPT、Grok 等主流编码模型，适合快速配置、精确计费和稳定调用。'
const DOCS_DESCRIPTION = '老实人AI Docs：快速开始、API 参考、工具集成和实时模型目录。'
