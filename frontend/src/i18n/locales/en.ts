export default {
  ...
  auth: {
    ...
    referralCodeHint: 'Enter the invite code from your referrer to earn bonuses for both of you on first recharge',
    linuxdo: {
  ...
  user: {
    referral: {
      ...
      firstRechargeReceived: 'First recharge invite bonus received',
      firstRechargePending: 'Complete your first recharge to claim your invite bonus',
      myInviteCode: 'My Invite Code & Invite Link',
  ...
  profile: {
    ...
    inviteCodeHintWithRates: 'You receive 5% of a friend’s first real purchase as ⚡ platform credit in real time. If it is at least ¥50, they receive an extra ⚡5 the next day.',
