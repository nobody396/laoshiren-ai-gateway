export default {
  ...
  keys: {
    ...
    codexAutoConfigCommandCopied: 'Codex 配置命令已复制，请粘贴到终端运行',
    keyMustBeActiveForCodexConfig: '请先启用该 API Key，再复制 Codex 配置命令',
