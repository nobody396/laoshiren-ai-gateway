...
func RegisterUserRoutes(
	...
	v1.GET("/public-downloads/cc-switch/packages/:assetID", h.Resource.DownloadCCSwitchPackage)
	v1.GET("/public-downloads/codex/windows-x64/latest.json", h.Resource.CodexWindowsLatestManifest)
	...
	authenticated.Use(middleware.BackendModeUserGuard(settingService))
	{
		...
		resources := authenticated.Group("/resources")
		{
			...
			resources.GET("/setup-plans", h.Resource.GetSetupPlans)
