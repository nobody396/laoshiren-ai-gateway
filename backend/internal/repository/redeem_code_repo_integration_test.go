...
func (s *RedeemCodeRepoSuite) TestUse_MarksSaleRechargeInventorySold() {
	user := s.createUser(uniqueTestValue(s.T(), "use-sale") + "@example.com")
	code := &service.RedeemCode{
		Code:        "USE-SALE",
		Type:        service.RedeemTypeBalance,
		Value:       20,
...
func (s *RedeemCodeRepoSuite) TestUse_DoesNotMarkGiftSold() {
	user := s.createUser(uniqueTestValue(s.T(), "use-gift") + "@example.com")
	code := &service.RedeemCode{
		Code:        "USE-GIFT",
		Type:        service.RedeemTypeBalance,
		Value:       20,
