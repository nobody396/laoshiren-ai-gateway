export default {
  ...
  user: {
    referral: {
      ...
      myInviteCode: 'My Invite Code & Invite Link',
      inviteHint: 'Invite friends to register — when they make their first top-up, both of you receive 5% of the amount as invite bonus',
  ...
  profile: {
    ...
    myInviteCode: 'My Invite Code & Invite Link',
    inviteCodeHint: 'Share this code with friends. They enter it on registration, and when they make their first top-up, both of your account balances increase by 5% of the amount.',
