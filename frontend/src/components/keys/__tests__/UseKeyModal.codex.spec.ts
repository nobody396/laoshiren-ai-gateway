...
describe('UseKeyModal Codex catalog', () => {
  ...
  it('lists all 8 enterprise group models in the downloaded catalog', async () => {
  ...
  it('keeps the legacy Pro 20X style catalog at exactly five models', async () => {
  ...
  it('uses the group default model when the catalog default is unavailable', async () => {
