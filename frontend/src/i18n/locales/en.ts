export default {
  ...
  profile: {
    ...
    inviteCodeHintWithRates: 'You receive 5% of a friend’s first real purchase as ⚡ platform credit in real time. If it is strictly over ¥50, they receive an extra ⚡5 the next day.',
