<template>
  <section class="card overflow-hidden">
    <div class="flex flex-col gap-4 border-b border-gray-100 p-5 dark:border-dark-700 lg:flex-row lg:items-center lg:justify-between">
      ...
      <RouterLink
        to="/get-subscription"
        class="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[#7a2d17]/20 bg-[#9a3b1f] px-4 text-sm font-semibold text-[#faf6ec] shadow-sm shadow-[#9a3b1f]/20 transition hover:-translate-y-0.5 hover:bg-[#7a2d17] hover:shadow-md hover:shadow-[#9a3b1f]/25 dark:border-[#ffb18b]/25 dark:bg-[#e18a68] dark:text-[#13100b] dark:shadow-[#e18a68]/10 dark:hover:bg-[#ffb18b]"
      >
