export default {
  ...
  admin: {
    ...
    agents: {
      ...
      inviteActivityRule: 'Rule: invited users registered during the campaign window receive the bonus immediately; users outside the invite link or time window do not.',
