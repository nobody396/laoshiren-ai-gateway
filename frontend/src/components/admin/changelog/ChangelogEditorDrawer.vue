...
.changelog-drawer-layer {
  ...
  background: rgb(var(--color-indigo-900) / 0.42);
...
.changelog-drawer-panel {
  ...
  box-shadow: -20px 0 60px rgb(var(--shadow-ink) / 0.16);
}
...
.changelog-drawer-panel h2 { margin: 0; color: rgb(var(--color-ink-deep)); font-size: 1.15rem; font-weight: 700; }
.changelog-drawer-panel header p { margin: 0.2rem 0 0; color: rgb(var(--color-muted)); font-size: 0.78rem; }
...
.changelog-drawer-close:hover { background: rgb(var(--color-parchment)); color: rgb(var(--color-ink-deep)); }
...
.changelog-editor-preview h3 { margin: 0.75rem 0 0; color: rgb(var(--color-ink-deep)); font-family: 'Noto Serif SC', serif; font-size: 1.35rem; line-height: 1.4; }
.changelog-editor-preview > p { color: rgb(var(--color-muted)); font-size: 0.9rem; line-height: 1.65; }
.changelog-editor-preview dl { margin-top: 1.5rem; border-left: 2px solid rgb(var(--color-laurel)); padding-left: 0.8rem; }
.changelog-editor-preview dt { color: rgb(var(--color-ink)); font-size: 0.75rem; font-weight: 700; }
.changelog-editor-preview dd { margin: 0.25rem 0 1rem; color: rgb(var(--color-muted)); font-size: 0.84rem; line-height: 1.55; }
...
.changelog-git-details summary { color: rgb(var(--color-ink)); font-size: 0.86rem; font-weight: 600; cursor: pointer; }
.dark .changelog-git-details summary { color: rgb(var(--color-gray-200)); }
.changelog-git-details > p { margin: 0.55rem 0 1rem; color: rgb(var(--color-muted)); font-size: 0.75rem; }
