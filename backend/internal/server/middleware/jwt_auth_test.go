...
func (r *stubJWTUserRepo) TouchLastActive(context.Context, int64, time.Time) error {
	return nil
}
...
func newJWTTestEnv(users map[int64]*service.User) (*gin.Engine, *service.AuthService) {
	...
	authSvc := service.NewAuthService(nil, userRepo, nil, nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil)
